...
//$result = restrictedArea($user, 'pacientes', $id, '','');
...
}elseif (file_exists(DOL_DOCUMENT_ROOT . '/core/actions_linkedfiles.inc.php')) {
...
llxHeader('', $langs->trans("Code52"), $helpurl);

if ($object->id)
{
    $head = pacientes_prepare_head($object);

    dol_fiche_head($head, 'documents', $langs->trans("Code52"), 0, 'contact');
