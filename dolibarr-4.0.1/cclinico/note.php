...
$permission=$user->rights->cclinico->leer;	// Used by the include of actions_setnotes.inc.php
$permissionnote=$user->rights->cclinico->leer;
/*
 * Actions
 */
...
llxHeader('',$langs->trans("Code51"), $help_url);
...
if ($id > 0)
{
    ...
    dol_fiche_head($head, 'note', $langs->trans("Code51"), 0, 'contact');
