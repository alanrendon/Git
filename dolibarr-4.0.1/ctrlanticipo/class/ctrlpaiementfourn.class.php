...
/**
 * \file    ctrlanticipo/ctrlpaiementfourn.class.php
...
/**
 * Class Ctrlpaiementfourn
 *
 * Put here description of your class
 * @see CommonObject
 */
class Ctrlpaiementfourn extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'ctrlpaiementfourn';
	/**
	...
	/**
	 * @var CtrlpaiementfournLine[] Lines
	 */
	public $lines = array();
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new CtrlpaiementfournLine();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Ctrlpaiementfourn($this->db);
