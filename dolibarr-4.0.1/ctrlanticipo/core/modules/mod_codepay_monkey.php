 ...
 */
class mod_codepay_monkey extends ModeleThirdPartyCode
{
	...
	function info($langs)
	{
		return $langs->trans("ctrl_conf_ref_def_payment");
	}
	...
	function getNextValue($object="")
	{
		...
		$sql.= " FROM llx_ctrl_paiementfourn";
		$sql.= " WHERE ref like '".$this->prefixcustomer."____-%'";
		...
		dol_syslog(__METHOD__." return ".$this->prefixcustomer.$yymm."-".$num);
		return  $this->prefixcustomer.$yymm."-".$num;
	}
