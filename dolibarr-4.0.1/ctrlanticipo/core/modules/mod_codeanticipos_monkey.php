 ...
 */
class mod_codeanticipos_monkey extends ModeleThirdPartyCode
{
	var $nom='Secuencial';					// Nom du modele
	var $name='Secuencial';					// Nom du modele
	...
	function info($langs)
	{
		return $langs->trans("ctrl_conf_ref_def");
	}
	...
	{
		return $this->prefixcustomer.'0001';
	}
	...
	function getNextValue($objsoc=0,$type=-1)
	{
		...
		}elseif ($type == 1 )
		{
			...
			if ($resql)
			{
				...
				if ($n>0) {
					...
					return $this->prefixsupplier.$obj->id.")";
				}else{
					return $this->prefixsupplier."1)";
				}
			}else{
				return $this->prefixsupplier."1)";
			}
		...
		$sql.= " FROM llx_ctrl_advance_provider";
