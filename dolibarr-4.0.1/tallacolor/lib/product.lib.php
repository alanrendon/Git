...
function product_prepare_head($object, $user)
{
	...
	//Agregado --> Tab Talla/Color
	//http://localhost/dolibarr_prb/htdocs/tallacolor/fiche.php?leftmenu=product&action=create&type=0&idmenu=348
	$head[$h][0] = DOL_URL_ROOT.'/tallacolor/fiche.php?id='.$object->id.'&action=editcolortalla';
	$head[$h][1] = $langs->trans('TallaColor');
	$head[$h][2] = 'tallacolor';
	$h++;
