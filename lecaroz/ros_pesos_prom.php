...
$descripcion_error[3] = "No exite el Proveedor";
...
$tpl->assignInclude("body","./plantillas/ros/ros_pesos_prom.tpl");//plantillas/$session->ruta/$session->plantilla");
$tpl->prepare();
...
// Seleccionar tabla
$tpl->assign("tabla","pesos_companias");
