...
$tpl->assignInclude("body","./plantillas/adm/admin_porc_altas.tpl");
$tpl->prepare();
...
{
	header("location: ./admin_porc_altas.php?codigo_error=2");
	die();
}

if ($_SESSION['tipo_usuario'] == 2 && $_GET['cia'] < 900) {
	header("location: ./admin_porc_altas.php?codigo_error=2");
	die();
}
...
{
	header("location: ./admin_porc_altas.php?codigo_error=1");
	die;
}
