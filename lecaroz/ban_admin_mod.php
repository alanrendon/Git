...
$tpl->assignInclude("body","./plantillas/ban/ban_admin_mod.tpl");
$tpl->prepare();
...
if($_POST['cont'] >0)
{
	for($i=0;$i<$_POST['cont'];$i++)
	{
		if($_POST['modificar'.$i]==1)
		{
			...
			$tpl->assign("i",$var);
			$var++;
			$tpl->assign('idadministrador',$_POST['idadministrador'.$i]);
			$cia = obtener_registro("catalogo_administradores",array("idadministrador"),array($_POST['idadministrador'.$i]),"","",$dsn);
