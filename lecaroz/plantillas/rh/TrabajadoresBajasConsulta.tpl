...
<title>Consulta de bajas foleadas de trabajadores</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/rh/TrabajadoresBajasConsulta.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Consulta de bajas foleadas de trabajadores</div>
