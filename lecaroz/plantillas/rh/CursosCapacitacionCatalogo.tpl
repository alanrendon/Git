...
<title>Cursos de capacitaci&oacute;n</title>
...
<script type="text/javascript" src="jscripts/rh/CursosCapacitacionCatalogo.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Cursos de capacitaci&oacute;n</div>
