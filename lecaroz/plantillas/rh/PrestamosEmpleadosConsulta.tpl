...
<title>Consulta de prestamos a empleados</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/rh/PrestamosEmpleadosConsulta.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Consulta de prestamos a empleados</div>
