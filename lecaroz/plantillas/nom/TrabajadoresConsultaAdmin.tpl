...
<title>Consulta de trabajadores (Aguinaldos)</title>
...
<script type="text/javascript" src="jscripts/nom/TrabajadoresConsultaAdmin.js"></script>
...
<body>
<div id="contenedor">
	<div id="titulo">Consulta de Trabajadores (Aguinaldos)</div>
