...
<!-- THE CAKE IS A LIE -->
<body>
<p id="title">DOCUMENTOS FALTANTES DE TRABAJADORES</p>
<p id="cia">{num_cia} {nombre_cia}</p>
<p>Sr(ta). Encargado(a), le recordamos que es muy importante solicite a los siguientes trabajadores <strong style="color:red;">entregar urgentemente los siguientes documentos para anexarlos a sus expedientes</strong>:</p>
<table align="center" id="lista">
	<thead>
		<tr>
			<th scope="col">#</th>
			<th scope="col">Nombre del trabajador</th>
			<th scope="col">Documentos faltantes</th>
		</tr>
	</thead>
	<tbody>
		<!-- START BLOCK : row -->
