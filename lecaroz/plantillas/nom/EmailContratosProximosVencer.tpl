...
<!-- THE CAKE IS A LIE -->
<body>
<p id="title">CONTRATOS DE TRABAJADORES PROXIMOS A VENCER</p>
<p id="cia">{num_cia} {nombre_cia}</p>
<p>Sr(ta). Encargado(a), le recordamos que es muy importante solicite a los siguientes trabajadores <strong>presentarse en los pr&oacute;ximos d&iacute;as antes de la fecha de vencimiento de su contrato</strong> en el &aacute;rea de <strong>Recursos Humanos</strong> ubicado en el <strong>Centro de Capacitaci&oacute;n Coyoac&aacute;n, Allende no. 5, Col. del Carmen, Coyoac&aacute;n Centro Hist&oacute;rico, D.F.,</strong> para la <strong>renovaci&oacute;n</strong> del mismo:</p>
