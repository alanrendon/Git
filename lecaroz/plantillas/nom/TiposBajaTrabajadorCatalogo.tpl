...
<title>Cat&aacute;logo de tipos de baja de trabajador</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/nom/TiposBajaTrabajadorCatalogo.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Cat&aacute;logo de tipos de baja de trabajador</div>
