<form name="Datos" class="FormValidator FormStyles" id="Datos">
	...
	<table class="tabla_captura">
		...
		<tr class="linea_off">
			<td colspan="2" align="left" scope="row">El empleado tiene un saldo pendiente de {saldo} y no puede ser cambiado de compañía.</td>
		</tr>
		<!-- END BLOCK :prestamo -->
		<tr>
		...
		<tr class="linea_off">
			...
			<td><input name="nombre" type="text" class="valid onlyText cleanText toUpper" id="nombre" value="{nombre}" size="20" maxlength="20" /></td>
		</tr>
		<tr class="linea_on">
			<th align="left" scope="row">Apellido paterno</th>
			<td><input name="ap_paterno" type="text" class="valid onlyText cleanText toUpper" id="ap_paterno" value="{ap_paterno}" size="20" maxlength="20" /></td>
		</tr>
		<tr class="linea_off">
			<th align="left" scope="row">Apellido materno</th>
			<td><input name="ap_materno" type="text" class="valid onlyText cleanText toUpper" id="ap_materno" value="{ap_materno}" size="20" maxlength="20" /></td>
		</tr>
		<tr class="linea_on">
