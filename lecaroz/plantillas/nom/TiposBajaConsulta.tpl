...
<title>Catálogo de tipos de baja de empleados</title>
...
<script type="text/javascript" src="jscripts/mootools/Form.MultipleFileInput.js"></script>
<script type="text/javascript" src="jscripts/mootools/Form.Upload.js"></script>
<script type="text/javascript" src="jscripts/nom/TiposBajaConsulta.js"></script>
<script type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Catálogo de tipos de baja de empleados</div>
