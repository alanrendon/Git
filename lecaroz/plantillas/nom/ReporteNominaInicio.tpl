...
<script type="text/javascript" src="jscripts/nom/ReporteNominaInicio.js"></script>
</head>
...
<div id="contenedor">
	...
	<div id="captura" align="center">
		<form action="ReporteNomina.php" method="post" enctype="multipart/form-data" name="Datos" class="FormValidator FormStyles" id="Datos">
