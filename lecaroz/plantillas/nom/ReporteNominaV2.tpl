...
<title>Reporte de n&oacute;minas</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/nom/ReporteNominaV2.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de n&oacute;minas</div><div id="captura" align="center"></div>
</div>
