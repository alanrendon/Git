...
<title>Trabajadores afiliados y no afiliados</title>
...
<script type="text/javascript" src="jscripts/AlertaTrabajadoresAfiliados.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<p class="bold font14 center">Trabajadores afiliados y no afiliados</p>
<form method="get" name="Datos" class="FormValidator FormStyles" id="Datos">
	<table align="center" class="print" id="empleados">
		<tr>
			...
			<th class="print">Afiliados</th>
			<th class="print">No afiliados</th>
		</tr>
		<!-- START BLOCK : row -->
		<tr>
			<td class="print">{num_cia} {nombre_cia}</td>
			<td align="right" class="print blue">{afiliados}</td>
			<td align="right" class="print red">{no_afiliados}</td>
		</tr>
		<!-- END BLOCK : row -->
		<tr>
			<th align="right" class="print">Total</th>
			<th align="right" class="print">{afiliados}</th>
			<th align="right" class="print">{no_afiliados}</th>
		</tr>
	</table>
