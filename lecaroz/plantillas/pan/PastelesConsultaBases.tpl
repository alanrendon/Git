...
<title>Reporte de devoluciones de base de pastel</title>
...
<script type="text/javascript" src="jscripts/pan/PastelesConsultaBases.js"></script>
<script type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Reporte de devoluciones de base de pastel</div>
