...
<head>
	...
	<title>Validaci&oacute;n de av&iacute;o</title>
	...
	<script type="text/javascript" src="/lecaroz/jscripts/pan/AvioValidacion.js"></script>
	<style type="text/css">
		.info-table {
...
<body>
	...
	<div id="contenedor">
		<div id="titulo">Validaci&oacute;n de av&iacute;o</div>
		<div id="captura" align="center"> </div>
	</div>

	<div id="auxiliar_wrapper" style="display:none; width:800px; height:600px;">
		<iframe id="auxiliar_frame" src="" style="width:100%; height:100%;"></iframe>
	</div>
