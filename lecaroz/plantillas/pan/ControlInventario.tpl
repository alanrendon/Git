...
<title>Control de inventario de panader&iacute;as</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/pan/ControlInventario.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Control de inventario de panader&iacute;as</div><div id="captura" align="center"></div>
</div>
