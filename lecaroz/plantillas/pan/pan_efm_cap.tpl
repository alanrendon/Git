...
<input name="temp" type="hidden">
  ...
  <table class="tabla">
	...
	<!-- START BLOCK : rows -->
    <tr>
        <td class="tabla"><input name="num_cia{i}" type="text"  class="insert" id="num_cia{i}" onFocus="form.temp.value=this.value" onChange="valor=isInt(this,form.temp); if (valor==false) this.select();" onKeyDown="if (event.keyCode == 13) form.am{i}.select(); if(event.keyCode == 37) document.form.desc_pastel{ant}.select(); if(event.keyCode == 38) document.form.num_cia{ant}.select(); if(event.keyCode==39) document.form.am{i}.select(); if(event.keyCode==40) document.form.num_cia{next}.select();" value="{num_cia}" size="3"></td>
		<td class="tabla"><input name="am{i}" type="text" class="insert" onChange="valor=isFloat(this,2,form.temp); if (valor==false) this.select(); venta_puerta(form.am{i},form.am_error{i},form.pm{i},form.pm_error{i},form.pastel{i},form.venta_pta{i});" value="{am}" size="5" onKeyDown="if (event.keyCode == 13) form.am_error{i}.select(); if(event.keyCode==37) form.num_cia{i}.select(); if(event.keyCode==38) form.am{ant}.select(); if(event.keyCode==39) form.am_error{i}.select(); if(event.keyCode==40) form.am{next}.select();" onFocus="form.temp.value=this.value"></td>
		<td class="tabla"><input name="am_error{i}" type="text" class="insert" value="{am_error}" size="5" onChange="valor=isFloat(this,2,form.temp); if (valor==false) this.select(); venta_puerta(form.am{i},form.am_error{i},form.pm{i},form.pm_error{i},form.pastel{i},form.venta_pta{i});" onFocus="form.temp.value=this.value" onKeyDown="if (event.keyCode == 13) form.pm{i}.select(); if(event.keyCode==37) form.am{i}.select(); if(event.keyCode==38) form.am_error{ant}.select(); if(event.keyCode==39) form.pm{i}.select(); if(event.keyCode==40) form.am_error{next}.select();"></td>
		<td class="tabla"><input name="pm{i}" type="text" class="insert" onChange="valor=isFloat(this,2,form.temp); if (valor==false) this.select(); venta_puerta(form.am{i},form.am_error{i},form.pm{i},form.pm_error{i},form.pastel{i},form.venta_pta{i});" value="{pm}" size="5" onFocus="form.temp.value=this.value" onKeyDown="if (event.keyCode == 13) form.pm_error{i}.select(); if(event.keyCode==37) form.am_error{i}.select(); if(event.keyCode==38) form.pm{ant}.select(); if(event.keyCode==39) form.pm_error{i}.select(); if(event.keyCode==40) form.pm{next}.select();"></td>
	  	<td class="tabla"><input name="pm_error{i}" type="text" class="insert" value="{pm_error}" size="5" onChange=" valor=isFloat(this,2,form.temp); if (valor==false) this.select(); venta_puerta(form.am{i},form.am_error{i},form.pm{i},form.pm_error{i},form.pastel{i},form.venta_pta{i});" onFocus="form.temp.value=this.value" onKeyDown="if (event.keyCode == 13) form.pastel{i}.select(); if(event.keyCode==37) form.pm{i}.select(); if(event.keyCode==38) form.pm_error{ant}.select(); if(event.keyCode==39) form.pastel{i}.select(); if(event.keyCode==40) form.pm_error{next}.select();"></td>
		<td class="tabla"><input name="pastel{i}" type="text" class="insert" onChange="valor=isFloat(this,2,form.temp); if (valor==false) this.select(); venta_puerta(form.am{i},form.am_error{i},form.pm{i},form.pm_error{i},form.pastel{i},form.venta_pta{i});" value="{pastel}" size="5" onFocus="form.temp.value=this.value" onKeyDown="if (event.keyCode == 13) form.pastillaje{i}.select(); if(event.keyCode==37) form.pm_error{i}.select(); if(event.keyCode==38) form.pastel{ant}.select(); if(event.keyCode==39) form.pastillaje{i}.select(); if(event.keyCode==40) form.pastel{next}.select();"></td>
		<td class="tabla"><input name="venta_pta{i}" type="text" class="insert" id="venta_pta{i}" value="{venta_pta}" size="7" readonly></td>
		<td class="tabla"><input name="pastillaje{i}" type="text" class="insert" id="pastillaje{i}" onFocus="form.temp.value=this.value" onChange="valor=isFloat(this,2,form.temp); if (valor==false) this.select();" value="{pastillaje}" size="5" onKeyDown="if (event.keyCode == 13) form.otros{i}.select(); if(event.keyCode==37) form.pastel{i}.select(); if(event.keyCode==38) form.pastillaje{ant}.select(); if(event.keyCode==39) form.otros{i}.select(); if(event.keyCode==40) form.pastillaje{next}.select();"></td>
		<td class="tabla"><input name="otros{i}" type="text" class="insert" id="otros{i}" onFocus="form.temp.value=this.value" onChange="valor=isFloat(this,2,form.temp); if (valor==false) this.select();" value="{otros}" size="5" onKeyDown="if (event.keyCode == 13) form.ctes{i}.select(); if(event.keyCode==37) form.pastillaje{i}.select(); if(event.keyCode==38) form.otros{ant}.select(); if(event.keyCode==39) form.ctes{i}.select(); if(event.keyCode==40) form.otros{next}.select();"></td>
		<td class="tabla"><input name="ctes{i}" type="text" class="insert" id="ctes{i}" onFocus="form.temp.value=this.value" onChange="valor=isInt(this,form.temp); if (valor==false) this.select();" value="{ctes}" size="5" onKeyDown="if (event.keyCode == 13) form.corte1{i}.select(); if(event.keyCode==37) form.otros{i}.select(); if(event.keyCode==38) form.ctes{ant}.select(); if(event.keyCode==39) form.corte1{i}.select(); if(event.keyCode==40) form.ctes{next}.select();"></td>
		<td class="tabla"><input name="corte1{i}" type="text" class="insert" id="corte1{i}" onFocus="form.temp.value=this.value" onChange="valor=isInt(this,form.temp); if (valor==false) this.select();" value="{corte1}" size="5" onKeyDown="if (event.keyCode == 13) form.corte2{i}.select(); if(event.keyCode==37) form.ctes{i}.select(); if(event.keyCode==38) form.corte1{ant}.select(); if(event.keyCode==39) form.corte2{i}.select(); if(event.keyCode==40) form.corte1{next}.select();")></td>
		<td class="tabla"><input name="corte2{i}" type="text" class="insert" id="corte2{i}" onFocus="form.temp.value=this.value" onChange="valor=isInt(this,form.temp); if (valor==false) this.select();" value="{corte2}" size="5" onKeyDown="if (event.keyCode == 13) form.desc_pastel{i}.select(); if(event.keyCode==37) form.corte1{i}.select(); if(event.keyCode==38) form.corte2{i}.select(); if(event.keyCode==39) form.desc_pastel{i}.select(); if(event.keyCode==40) form.corte2{next}.select();"></td>
		<td class="tabla"><input name="desc_pastel{i}" type="text" class="insert" id="desc_pastel{i}" onFocus="form.temp.value=this.value" onChange="valor=isFloat(this,2,form.temp); if (valor==false) this.select();" value="{desc_pastel}" size="5" onKeyDown="if (event.keyCode == 13) form.num_cia{next}.select(); if(event.keyCode==37) form.corte2{i}.select(); if(event.keyCode==38) form.desc_pastel{ant}.select(); if(event.keyCode==39) form.num_cia{next}.select(); if(event.keyCode==40) form.desc_pastel{next}.select();"></td>
    </tr>
	<!-- END BLOCK : rows -->
  </table>
  <p>
...
<table class="tabla">
  ...
  <tr class="tabla">
    <td class="tabla" bgcolor="#0000FF"></td>
    <td class="vtabla">Compañía repetida</td>
  </tr>
  <tr class="tabla">
    <td class="tabla" bgcolor="#FFCC99"></td>
    <td class="vtabla">Importe de descuento de pastel no v&aacute;lido</td>
  </tr>
  <tr class="tabla">
    <td class="tabla" bgcolor="#FF3399"></td>
    <td class="vtabla">Revise el n&uacute;mero de clientes </td>
  </tr>
</table>
