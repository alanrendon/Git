...
<tr>
<td align="center" valign="middle"><p class="title">Borrar Movimientos de Expendios
 </p>
  <form action="./pan_mov_exp_del.php" method="get" name="form">
...
function validar() {
	if (confirm('¿Esta seguro de borrar todos los movimientos con fecha ' + f.fecha.value + ' en adelante?'))
		f.submit();
	else
		f.num_cia.select();
}
