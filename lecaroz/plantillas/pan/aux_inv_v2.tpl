...
<table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr align="center" valign="middle">
    <td>
      ...
      <form action="./aux_inv_v2.php" method="get" name="form" onKeyPress="if (event.keyCode == 13) return false">
        <table class="tabla">
          <tr>
          ...
          <tr>
            ...
            <td class="vtabla"><input name="listado" type="radio" value="desglozado" checked>
              Desglozado<br>
              <input name="listado" type="radio" value="totales">
              Totales</td>
          </tr>
          <tr>
