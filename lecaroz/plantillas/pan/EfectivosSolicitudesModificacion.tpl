...
<title>Solicitud de modificación de efectivos</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/pan/EfectivosSolicitudesModificacion.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Solicitud de modificación de efectivos</div>
