...
<title>Consulta de Producci&oacute;n</title>
...
<script type="text/javascript" src="jscripts/pan/ConsultaProduccion.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Consulta de Producci&oacute;n </div>
  <!-- START BLOCK : normal -->
