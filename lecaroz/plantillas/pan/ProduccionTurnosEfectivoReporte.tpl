...
<script type="text/javascript" src="/lecaroz/jscripts/pan/ProduccionTurnosEfectivoReporte.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Reporte de efectivos con respecto a producci&oacute;n</div>
