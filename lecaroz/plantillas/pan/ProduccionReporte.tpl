...
<script type="text/javascript" src="/lecaroz/jscripts/pan/ProduccionReporte.js"></script>
</head>
		...
		<form name="inicio" class="FormValidator" id="inicio">
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<td class="bold" scope="row">Producto(s)</td>
						<td><input name="productos" type="text" class="validate toInterval" id="productos" size="30" /></td>
					</tr>
					<tr>
						<td class="bold" scope="row">Reporte anual</td>
						<td><input name="reporte_anual" type="checkbox" id="reporte_anual" value="1" />
							Si</td>
					</tr>
				</tbody>
				<tfoot>
