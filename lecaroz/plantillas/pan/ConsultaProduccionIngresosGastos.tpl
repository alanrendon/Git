...
<script type="text/javascript" src="jscripts/pan/ConsultaProduccionIngresosGastos.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Reporte de Producci&oacute;n, Ingresos y Gastos </div>
  <!-- START BLOCK : normal -->
