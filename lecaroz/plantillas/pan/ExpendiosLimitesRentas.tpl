...
<title>L&iacute;mites de rentas de expendios</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/pan/ExpendiosLimitesRentas.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">L&iacute;mites de rentas de expendios</div><div id="captura" align="center"></div>
</div>
