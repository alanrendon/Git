...
<p class="title">Reporte para la prueba de pan con pastel </P>
<form name="form" action="./pan_ppn_con3.php" method="get">
...
<td align="center" valign="top">
  ...
  <tr class="listado">
	<th class="listado">Cia.: {num_cia}</th>
  	<th class="listado" colspan="12"><font size="-2"><strong>{num_cia}-{nom_cia}</strong></font></th>
	<th class="listado">Cia.: {num_cia}</th>
  </tr>
  <tr class="listado">
 	<th class="listado">&nbsp;</th>
  	<th class="listado" colspan="12">Reporte para la PRUEBA DE PAN CON PASTEL al {dia} de {mes} de {anio}</th>
  ...
  <tr class="listado">
    ...
    <th scope="col" class="listado">Pastel <br>anticipo</th>
...
<!-- START BLOCK : rows -->
 ...
 <!-- END BLOCK : rows -->
  <tr>
	...
	<th class="rlistado">&nbsp;&nbsp;&nbsp;&nbsp;{total_pastel}</th>
  ...
  <tr>
    <th scope="row" class="listado_total">&nbsp;</th>
    <th class="rlistado" colspan="3">Efectivo/ Produccion&nbsp;&nbsp;&nbsp;</th>
...
<table class="listado">
  ...
  <tr class="listado">
    ...
    <th scope="col" class="listado">Ventas para el dia</th>
    <th scope="col" class="listado">Reparto</th>
