...
<title>Comparativo de clientes</title>
...
<script type="text/javascript" src="jscripts/pan/ClientesComparativo.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Comparativo de clientes</div>
	<div id="captura" align="center">
		...
		<form action="" method="post" name="Datos" class="FormValidator FormStyles" id="Datos">
			<table class="tabla_captura">
				...
				<tr class="linea_off">
					<th align="left" scope="row">Años(s)</th>
					<td><input name="anios" type="text" class="valid toInterval" id="anios" value="{anio}" size="30" /></td>
				</tr>
			</table>
			<p>
