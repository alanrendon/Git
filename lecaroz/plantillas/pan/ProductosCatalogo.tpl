...
<script type="text/javascript" src="/lecaroz/jscripts/pan/ProductosCatalogo.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Catálogo de Productos</div><div id="captura" align="center"></div>
</div>
