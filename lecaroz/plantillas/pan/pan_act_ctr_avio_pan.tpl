...
<tr>
<td align="center" valign="middle"><p class="title">Actualizar Control de Av&iacute;o en Panaderias</p>
  <form action="pan_act_ctr_avio_pan.php" method="get" name="form">
