...
<td>
<p class="title">AUXILIAR DE INVENTARIOS DE MATERIA PRIMA<br>
  COMPARATIVO COMPRA DE FACTURAS</p>
<form name="form" method="get" action="./comparativo.php">
<table class="tabla">
  <tr>
...
<table class="print">
  ...
  <!-- START BLOCK : mp -->
  <tr>
    <th colspan="11" class="vprint">{codmp} {nombremp} </th>
  </tr>
  <tr>
...
<table class="print" width="80%">
  ...
  <tr>
    ...
    <th class="rprint">&nbsp;</th>
    <th class="rprint">&nbsp;</th>
    <th class="rprint"><font size="-1" color="#FFFF00">{total_valores_entrada_total}</font></th>
    <th class="rprint">&nbsp;</th>
    <th class="rprint"><font size="-1" color="#FFFF00">{total_valores_salida_total}</font></th>
    <th class="rprint">&nbsp;</th>
  ...
  <tr>
<th colspan="5">&nbsp;</th>
    <th class="rprint"><font size="-1" color="#FFFF00">{facturas}</font></th>
