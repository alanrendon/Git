...
<p class="title">Asignaci&oacute;n de orden de materias primas</p>
<form name="form" method="get" action="pan_avi_ord.php">
...
<table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr>
<td align="center" valign="middle"><p class="title">Asignaci&oacute;n de orden de materias primas </p>
<table class="tabla">
  <tr>
    <th class="tabla" scope="col">Compa&ntilde;&iacute;a</th>
  </tr>
  ...
  <form name="form" method="post" action="./pan_avi_ord.php?tabla=control_avio">
  <input name="temp" type="hidden">
  ...
  <table class="tabla">
	...
	<tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
      ...
      <td class="vtabla"><strong>{nombre_mp}</strong></td>
