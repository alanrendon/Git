...
<td align="center" valign="middle"><p class="title">Consumos Acumulados en Valores </p>
  <form action="./pan_con_acu.php" method="get" name="form"><table class="tabla">
    <tr>
...
<table width="100%">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" class="print">
	...
	<tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
	  <th colspan="3" class="vprint">Consumo del mes </th>
	  <td class="rprint">{1_consumo_mes}</td>
	  <td class="rprint">{2_consumo_mes}</td>
	  <td class="rprint">{3_consumo_mes}</td>
	  <td class="rprint">{4_consumo_mes}</td>
	  <td class="rprint">{8_consumo_mes}</td>
	  <td class="rprint">{9_consumo_mes}</td>
	  <td class="rprint">{10_consumo_mes}</td>
	  <td class="rprint">{consumo_mes}</td>
	</tr>
	<tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
	  <th colspan="3" class="vprint">Faltante del mes </th>
	  <td class="rprint"><font color="#FF0000">{1_faltante}</font></td>
	  <td class="rprint"><font color="#FF0000">{2_faltante}</font></td>
	  <td class="rprint"><font color="#FF0000">{3_faltante}</font></td>
	  <td class="rprint"><font color="#FF0000">{4_faltante}</font></td>
	  <td class="rprint"><font color="#FF0000">{8_faltante}</font></td>
	  <td class="rprint"><font color="#FF0000">{9_faltante}</font></td>
	  <td class="rprint"><font color="#FF0000">{10_faltante}</font></td>
	  <td class="rprint"><font color="#FF0000">{total_faltante}</font></td>
	  </tr>
	<tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
	  <th colspan="3" class="vprint">Sobrante del mes </th>
	  <td class="rprint"><font color="#0000FF">{1_sobrante}</font></td>
	  <td class="rprint"><font color="#0000FF">{2_sobrante}</font></td>
	  <td class="rprint"><font color="#0000FF">{3_sobrante}</font></td>
	  <td class="rprint"><font color="#0000FF">{4_sobrante}</font></td>
	  <td class="rprint"><font color="#0000FF">{8_sobrante}</font></td>
	  <td class="rprint"><font color="#0000FF">{9_sobrante}</font></td>
	  <td class="rprint"><font color="#0000FF">{10_sobrante}</font></td>
	  <td class="rprint"><font color="#0000FF">{total_sobrante}</font></td>
	  </tr>
	<tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
