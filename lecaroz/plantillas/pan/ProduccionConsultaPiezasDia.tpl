...
<title>Consulta de produccion de piezas</title>
...
<script type="text/javascript" src="jscripts/pan/ProduccionConsultaPiezasDia.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Consulta de producción de piezas</div>
