...
<script type="text/javascript" src="/lecaroz/jscripts/pan/IEPSReporte.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Reporte de I.E.P.S.</div>
		...
		<form name="inicio" class="FormValidator" id="inicio">
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<td class="bold" scope="row">Contador</td>
						<td><select name="conta" id="conta">
								<option value=""></option>
								<!-- START BLOCK : conta -->
								<option value="{value}">{text}</option>
								<!-- END BLOCK : conta -->
