...
<td align="center" valign="top">
  ...
  <table width="100%" border="0" cellpadding="0" class="listado">
  <tr class="listado">
  	<th class="listado" colspan="19"><font size="-2"><strong>Porcentajes de materia prima respecto a la Harina al {dia} de {mes} de {anio} {hora}</strong></font></th>
  </tr>
