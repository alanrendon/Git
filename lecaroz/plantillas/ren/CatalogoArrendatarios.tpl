...
<title>Cat&aacute;logo de Arrendatarios</title>
...
<script type="text/javascript" src="jscripts/ren/CatalogoArrendatarios.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Cat&aacute;logo de Arrendatarios</div>
