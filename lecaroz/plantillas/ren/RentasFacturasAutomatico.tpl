...
<title>Recibos de arrendamiento (automático)</title>
...
<script type="text/javascript" src="jscripts/ren/RentasFacturasAutomatico.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Recibos de arrendamiento (automático)</div>
