...
<tr>
<td align="center" valign="middle"><p class="title">Alta de Local</p>
  <form action="./ren_art_alta.php" method="post" name="form">
    ...
    <tr>
      ...
      <td class="vtabla"><input name="nombre_local" type="text" class="vinsert" id="nombre_local" style="width: 100%;" onKeyUp="if (event.keyCode == 13) direccion_local.select()" value="{nombre_local}" size="30" maxlength="50"></td>
    ...
    <tr>
      ...
      <td class="vtabla"><textarea name="direccion_local" cols="25" rows="3" class="insert" id="direccion_local" style="width: 100%;" onKeyDown="if (event.keyCode == 13) email.select()">{direccion_local}</textarea></td>
    ...
    <tr>
      ...
      <td class="vtabla"><input name="tipo_persona" type="radio" value="FALSE" checked>
        F&iacute;sica
          <input name="tipo_persona" type="radio" value="TRUE">
          Moral</td>
    </tr>
    <tr>
      <th class="vtabla" scope="row">Inicio de Contrato</th>
      <td class="vtabla"><input name="fecha_inicio" type="text" class="insert" id="fecha_inicio" onFocus="tmp.value=this.value;this.select()" onChange="inputDateFormat(this)" onKeyDown="if (event.keyCode == 13) fecha_final.select()" value="{fecha1}" size="10" maxlength="10"></td>
    ...
    <tr>
      ...
      <td class="vtabla"><input name="fecha_final" type="text" class="insert" id="fecha_final" onFocus="tmp.value=this.value;this.select()" onChange="inputDateFormat(this)" onKeyDown="if (event.keyCode == 13) metros.select()" value="{fecha2}" size="10" maxlength="10"></td>
      <th class="vtabla">Bloque</th>
      <td class="vtabla"><input name="bloque" type="radio" value="1" checked>
        Interno
	...
	<tr>
	  ...
	  <td class="vtabla"><input name="tipo_local" type="radio" id="radio" value="1" checked{tipo_local_1}>
	    Comercial
    ...
    <tr>
      ...
      <td class="vtabla"><input name="retencion_iva" type="radio" value="TRUE" checked>
        Si
          <input name="retencion_iva" type="radio" value="FALSE">
          No</td>
      <th class="vtabla">Retenci&oacute;n de I.S.R.</th>
      <td class="vtabla"><input name="retencion_isr" type="radio" value="TRUE" checked>
        Si
          <input name="retencion_isr" type="radio" value="FALSE">
          No</td>
    </tr>
    <tr>
      <th class="vtabla" scope="row">Fianza</th>
      <td class="vtabla"><input name="fianza" type="radio" value="TRUE" checked>
        Si
          <input name="fianza" type="radio" value="FALSE">
          No</td>
      <th class="vtabla">Incremento Anual </th>
      <td class="vtabla"><input name="incremento_anual" type="radio" value="TRUE" checked>
        Si
          <input name="incremento_anual" type="radio" value="FALSE">
          No&nbsp;&nbsp;&nbsp;+%
          <input name="por_incremento" type="text" class="rinsert" id="por_incremento" onFocus="tmp.value=this.value;this.select()" onChange="isFloat(this,2,tmp)" onKeyDown="if (event.keyCode == 13) cargo_daños.select()" size="5" maxlength="5"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="vtabla"><input name="recibo_mensual" type="radio" value="TRUE" checked>
        Si
          <input name="recibo_mensual" type="radio" value="FALSE">
          No</td>
