...
<script type="text/javascript" src="jscripts/AlertaTrabajadoresNoFirmaContrato.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<p class="bold font14 center">Trabajadores sin contrato firmado</p>
<form method="get" name="Datos" class="FormValidator FormStyles" id="Datos">
	<!-- START BLOCK : admin -->
	<table align="center" class="print" id="empleados">
		<tr>
			<th colspan="2" align="left" class="print font16" scope="col">{admin}</th>
		</tr>
		<!-- START BLOCK : cia -->
		<tr>
