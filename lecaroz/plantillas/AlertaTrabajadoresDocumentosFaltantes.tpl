...
<title>Documentos faltantes de trabajadores</title>
...
<script type="text/javascript" src="jscripts/AlertaTrabajadoresDocumentosFaltantes.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<p class="bold font14 center noDisplay">Documentos faltantes de trabajadores</p>
<form method="get" name="Datos" class="FormValidator FormStyles" id="Datos">
	...
	<table align="center" class="print" id="empleados">
		...
		<tr>
			...
			<th class="print">Documentos faltantes</th>
		</tr>
		<!-- START BLOCK : empleado -->
		<tr>
			<td align="right" class="print"><input name="id[]" type="hidden" id="id" value="{id}" />{num_emp}</td>
			<td class="print">{empleado}</td>
			<td class="print">{documentos_faltantes}</td>
		</tr>
		<!-- END BLOCK : empleado -->
		<tr>
