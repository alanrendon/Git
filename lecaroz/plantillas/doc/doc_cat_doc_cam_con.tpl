...
<tr>
<td align="center" valign="middle"><p class="title">Consulta de Tipos de Documentos de Camionetas </p>
  <table class="tabla">
    <tr>
...
<script language="javascript" type="text/javascript">
	function mod(id) {
		document.location = "./doc_cat_doc_cam_con.php?accion=mod&id=" + id;
	}
	
	function del(id) {
		if (confirm("¿Desea borrar el registro?"))
			document.location = "./doc_cat_doc_cam_con.php?accion=del&id=" + id;
		else
			return false;
	}
</script>
...
<table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr>
<td align="center" valign="middle"><p class="title">Modificar de Tipo de Documento de Camioneta</p>
  <form action="./doc_cat_doc_cam_con.php" method="post" name="form" onKeyDown="if (event.keyCode == 13) return false">
  ...
  <table class="tabla">
    ...
    <input type="button" class="boton" value="Cancelar" onClick="document.location='./doc_cat_doc_cam_con.php'">
&nbsp;&nbsp;    
