...
<tr>
<td align="center" valign="middle"><p class="title">Alta de Tipos de Documento de Camionetas </p>
  <form action="./doc_cat_doc_cam_altas.php" method="post" name="form" onKeyDown="if (event.keyCode == 13) return false"><table class="tabla">
    <tr>
