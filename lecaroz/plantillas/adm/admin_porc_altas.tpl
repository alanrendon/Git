...
<p class="title">ALTA DE PORCENTAJES DE ACCIONISTAS</p>
<form name="form" action="./admin_porc_altas.php" method="get">
<table class="tabla" >
  <tr class="tabla">
...
<tr>
<td align="center" valign="middle">
<p class="title">ALTA DE PORCENTAJES PARA COMPAÑÍAS</p>
<form name="form" action="./insert_adm_porc.php" method="post">
