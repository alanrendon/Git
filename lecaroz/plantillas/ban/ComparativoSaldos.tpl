...
<title>Comparativo de saldos</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ComparativoSaldos.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Comparativo de saldos</div>
