...
<td align="center" valign="middle"><p class="title">Captura de Cheques</p>
  <form action="./ban_cap_che.php" method="post" name="form">
	...
	<tr>
      ...
      <td class="tabla"><input name="fecha[]" type="text" class="insert" id="fecha" onChange="actualiza_fecha(this)" onKeyDown="if (event.keyCode == 13) concepto[{i}].select()" value="{fecha}" size="10" maxlength="10"></td>
	...
	<tr>
	  ...
	  <td colspan="5" class="vtabla"><input name="num_fact0[]" type="text" class="insert" id="num_fact0" onFocus="tmp.value=this.value;this.select()" onChange="isInt(this,tmp)" onKeyDown="if (event.keyCode == 13) num_fact1[{i}].select()" value="{num_fact}" size="8">
