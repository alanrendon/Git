...
<title>Archivo de Facturas para Contadores </title>
...
<script type="text/javascript" src="jscripts/ban/ArchivoFacturasContadores.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Archivo de Facturas para Contadores </div>
  <div id="captura" align="center">
    <form name="Datos" class="formulario" id="Datos">
      ...
      <tr class="linea_on">
        ...
        <td class="linea_on"><select name="contador" id="contador">
      ...
      <tr class="linea_on">
        ...
        <td><input name="pendientes" type="checkbox" class="checkbox" id="pendientes" value="1" checked="checked" />
          Pendientes<br />
          <input name="pagadas" type="checkbox" class="checkbox" id="pagadas" value="1" checked="checked" />
          Pagadas<br />
          <input name="solo_iva" type="checkbox" class="checkbox" id="solo_iva" value="1" />
          Solo con I.V.A.</td>
      </tr>
    </table>
      <p>
