...
<p class="title">Consulta al catálogo de Contadores </P>

<form name="form" method="post" action="./ban_conta_mod.php?tabla={tabla}" onKeyDown="if (event.keyCode == 13) document.form.enviar.focus();">
  <br>
<table class="tabla">
    <tr class="rtabla">
      ...
      <th class="tabla" align="center">Nombre del Contador(a) </th>
    ...
    <tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
	  ...
	  <input name="idcontador{i}" type="hidden" value="{idcontador}">
	  </th>
	
      <td class="vtabla"><strong>{nombre_contador}</strong>
        <input name="nombre_contador{i}" type="hidden" id="nombre_contador{i}" value="{nombre_contador}">
      </td>
