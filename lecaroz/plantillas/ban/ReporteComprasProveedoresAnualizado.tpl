...
<title>Reporte de compras a proveedores anualizado</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ReporteComprasProveedoresAnualizado.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de compras a proveedores anualizado</div>
