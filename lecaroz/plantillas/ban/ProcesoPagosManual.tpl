...
<head>
	...
	<title>Proceso de pagos manual</title>
	...
	<script type="text/javascript" src="/lecaroz/jscripts/ban/ProcesoPagosManual.js?v={random}"></script>
	<style type="text/css">
		.info-table {
...
<body>
	...
	<div id="contenedor">
		<div id="titulo">Proceso de pagos manual</div>
