...
<title>Complemento de depósitos por gasto de nómina</title>
...
<script type="text/javascript" src="jscripts/ban/DepositosComplemento.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Complemento de depósitos por gasto de nómina</div>
