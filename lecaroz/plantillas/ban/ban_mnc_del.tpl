...
<form name="form" method="post" action="./ban_mnc_del.php">
<input name="id" value="{id}" type="hidden">
<p><strong><font face="Geneva, Arial, Helvetica, sans-serif">&iquest;Esta seguro de borrar el movimiento?</font></strong></p>
<p>
