...
<title>Reporte de devoluciones de I.V.A. anualizado</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ReporteIVADevueltoAnualizado.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de devoluciones de I.V.A. anualizado</div>
