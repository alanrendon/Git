...
<tr>
<td align="center" valign="middle"><p class="title">Carta de Autorizaci&oacute;n </p>
  <form action="./ban_che_aut.php?carta=1" method="post" name="form">
...
else if (event.keyCode == 37) folio{i}.select();
