...
<title>Catálogo de contadores</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/CatalogoContadores.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Catálogo de contadores</div>
