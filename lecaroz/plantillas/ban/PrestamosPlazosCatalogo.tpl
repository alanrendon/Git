...
<title>Catálogo de administradores</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/CatalogoAdministradores.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Catálogo de prestamos a plazos</div>
