...
<tr>
<td align="center" valign="middle"><p class="title">Pago de Impuestos Federales, IMSS e Infonavit </p>
  <form action="./ban_imp_fed_v2.php" method="post" name="form" enctype="multipart/form-data">
