...
<tr>
<td align="center" valign="middle"><p class="title">Captura de Importes para Facturas de Talleres </p>
  <form action="./ban_imp_tal.php" method="post" name="form" onKeyPress="if (event.keyCode == 13) return false">
