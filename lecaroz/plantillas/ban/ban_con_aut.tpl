...
<form name="form" enctype="multipart/form-data" method="post" action="./ban_con_aut.php?">
...
<script language="javascript" type="text/javascript">
	function valida_registro() {
		if (document.form.userfile.value == "" && confirm('No especifico el archivo de movimientos, ¿desea conciliar de todas maneras?')) {
			document.location = './ban_con_aut.php?conciliar=1';
			return false;
		}
...
<script language="javascript" type="text/javascript">
	function siguiente() {
		document.location = './ban_con_aut.php?val_cod=1';
	}
	
	function cancelar() {
		document.location = './ban_con_aut.php?cancelar=1';
	}
</script>
 <!-- END BLOCK : val_cue -->
...
<script language="javascript" type="text/javascript">
	function cancelar() {
		document.location = './ban_con_aut.php';
	}
</script>
 <!-- END BLOCK : val_cod -->
...
<form name="form" method="post" action="./ban_con_aut.php?conciliar=1">
<input name="numfilas" type="hidden" value="{numfilas}">
 ...
 <p>
 <input type="button" class="boton" value="Cancelar" onClick="document.location = './ban_con_aut.php?cancelar=1'">
  &nbsp;&nbsp;
...
<script language="javascript" type="text/javascript">
	function siguiente() {
		window.open("./ban_con_aut.php?popup=1","popup","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=200");
		document.form.submit();
	}
...
<td align="center" valign="middle"><p class="title">Saldos Bajos</p>
  ...
  <p>
    <input type="button" class="boton" value="Continuar" onClick="document.location='./ban_con_aut.php?resultados=1'">
  </p>  <p>&nbsp; </p></td>
</tr>
</table>
<!-- END BLOCK : saldos -->
...
&nbsp;&nbsp;  
<input type="button" class="boton" value="Terminar" onClick="document.location = './ban_con_aut.php'">
</p>
</td>
</tr>
</table>
