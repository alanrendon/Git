...
<form name="form" method="post" action="./ban_pau_pro_v2.php">
...
<input name="prelistado" type="hidden" value="1">
  <table class="tabla">
    ...
    <tr>
      ...
      <td class="vtabla"><input name="fecha_corte" type="text" class="insert" id="fecha_corte" onChange="actualiza_fecha(this)" onKeyDown="if (event.keyCode == 13) dias_deposito.select();" value="{fecha_corte}" size="10" maxlength="10">
      </td>
      </tr>
    <tr>
...
<span class="vtabla">
<input name="fecha_corte" type="text" class="insert" id="fecha_corte2" onChange="actualiza_fecha(this)" onKeyDown="if (event.keyCode == 13 || event.keyCode == 40) form.dias_deposito.select();
...
<td align="center" valign="middle"><p class="title">Pago Autom&aacute;tico a Proveedores <br>
  ...
  <form action="./ban_pau_pro_v2.php" method="post" name="form">
  ...
  <p>
    <input type="button" class="boton" value="Cancelar" onClick="document.location='./ban_pau_pro_v2.php'">
&nbsp;&nbsp; 
<input type="button" class="boton" value="Siguiente" onClick="valida_registro(form)">
  </p></form></td>
</tr>
...
<table align="center" class="print">
  ...
  <tr>
    ...
    <th colspan="2" class="print" scope="col">{nombre_cia}</th>
  </tr>
  <tr>
