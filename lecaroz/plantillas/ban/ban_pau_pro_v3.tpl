...
<form name="form" method="post" action="./ban_pau_pro_v3.php">
...
<td align="center" valign="middle"><p class="title">Pago Autom&aacute;tico a Proveedores <br>
  ...
  <form action="./ban_pau_pro_v3.php" method="post" name="form">
  ...
  <p>
    <input type="button" class="boton" value="Cancelar" onClick="document.location='./ban_pau_pro_v3.php'">
&nbsp;&nbsp; 
<input type="button" class="boton" value="Siguiente" onClick="valida_registro(form)">
  </p></form></td>
</tr>
