...
<tr>
<td align="center" valign="middle"><p class="title">Modificaci&oacute;n de Otros Dep&oacute;sitos</p>
  <form action="./ban_dot_mod_v2.php" method="get" name="form"><table class="tabla">
    <tr>
