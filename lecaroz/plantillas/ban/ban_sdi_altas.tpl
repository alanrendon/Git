<!-- catalogo subdelegaciones del imss  -->
<script type="text/javascript" language="JavaScript">
	function valida_registro() {
		if(document.form.campo0.value <= 0) {
			alert('Debe especificar un codigo para la delegacion');
...
<table class="tabla">
  <tr>
    <th class="vtabla">C&oacute;digo de Sub-Delegaci&oacute;n del IMSS</th>
  ...
  <p>
    <img src="./menus/insert.gif" align="middle">&nbsp;&nbsp;<input type="button" name="enviar" class="boton" value="Alta de Sub-Delegaci&oacute;n" onclick='valida_registro()'>
    <br><br>
