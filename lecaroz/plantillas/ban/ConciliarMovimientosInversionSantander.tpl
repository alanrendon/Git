...
<title>Conciliación de movimientos de inversión Santander</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ConciliarMovimientosInversionSantander.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Conciliaci&oacute;n de movimientos de inversi&oacute;n Santander</div>
	<div id="captura" align="center"></div>
</div>
<div id="conciliar_wrapper" style="display:none;">
	<form method="post" name="conciliar_movimientos" class="FormValidator center" id="conciliar_movimientos">
		<p>Conciliar movimientos de inversión del día <span id="fecha_movimientos" class="bold blue">fecha</span> con el siguiente concepto:</p>
		<p>
			<input name="concepto" type="text" id="concepto" value="INVERSION A 14 DIAS" size="40" />
		</p>
	</form>
</div>
<div id="complete_wrapper" style="display:none;">
	<p>Los movimientos de inversión del día <span id="fecha_complete" class="bold blue">fecha</span> han sido conciliados.</p>
</div>
