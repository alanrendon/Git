...
<script type="text/javascript" src="/lecaroz/jscripts/mootools/extensiones.js"></script>
<script type="text/javascript" src="/lecaroz/jscripts/ban/ReporteEstadoCuenta.js"></script>
...
<table width="98%" align="center" class="print">
  ...
  <tr>
    <td colspan="10" class="print" scope="col">
	<table width="100%" style="border-collapse:collapse;">
      <tr>
        <th colspan="4" align="left" class="print font12">Saldo Inicial </th>
        </tr>
      <tr>
        <th class="print font10">Banco</th>
        <th class="print font10">Cuenta</th>
        <th class="print font10">Saldo Banco </th>
        <th class="print font10">Saldo Libro </th>
      </tr>
	  ...
	  <tr>
        ...
        <td align="right" class="print bold font14 orange">{saldo_libro}</td>
      </tr>
      <!-- END BLOCK : banco_ini -->
	  ...
	  <tr>
        ...
        <th align="right" class="print font14 orange">{saldo_libro}</th>
      </tr>
	  <!-- END BLOCK : total_ini -->
    </table>	</td>
  </tr>
  ...
  <tr id="row">
    ...
    <td align="center" class="print orange"><a class="info" title="{info}">{conciliado}</a></td>
    <td align="right" class="print blue">{abono}</td>
    <td align="right" class="print red">{cargo}</td>
    <td align="center" class="print{color_folio}">{folio}</td>
  ...
  <tr>
    <th colspan="4" align="right" class="print font10">Conciliados</th>
    <th align="right" class="print font10 blue">{abonos}</th>
    <th align="right" class="print font10 red">{cargos}</th>
    <th colspan="4" class="print">&nbsp;</th>
  </tr>
  ...
  <tr>
    <td colspan="10" class="print">
	<table width="100%" style="border-collapse:collapse;">
      <tr>
        <th colspan="5" align="left" class="print font12">Saldo al Corte </th>
        </tr>
      <tr>
        <th class="print font10">Banco</th>
        <th class="print font10">Cuenta</th>
        <th class="print font10">Saldo Banco </th>
        <th class="print font10">Saldo Libro </th>
        <th class="print font10">Diferencia</th>
      </tr>
      ...
      <tr>
        ...
        <td align="right" class="print bold font14 blue">{saldo_banco}</td>
        <td align="right" class="print bold font14 orange">{saldo_libro}</td>
        <td align="right" class="print bold font14{color_dif}">{dif}</td>
      </tr>
	  <!-- END BLOCK : banco_fin -->
	  ...
	  <tr>
        ...
        <th align="right" class="print font14 blue">{saldo_banco}</th>
        <th align="right" class="print font14 orange">{saldo_libro}</th>
        <th align="right" class="print font14{color_dif}">{dif}</th>
      </tr>
	  <!-- END BLOCK : total_fin -->
    </table>	</td>
  </tr>
