...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ReimpresionPolizas.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	...
	<div id="captura" align="center">
		<form action="" method="post" name="captura_polizas" class="FormValidator" id="captura_polizas">
			<table class="table">
				<thead>
					<tr>
						<th>Compañía</th>
