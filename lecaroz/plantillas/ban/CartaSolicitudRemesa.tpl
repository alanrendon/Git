...
<div id="hoja">
  ...
  <p id="cuerpo">
  Por este medio autorizamos a Banco Santander (México), S.A. a realizar el cargo a la cuenta <strong>{cuenta}</strong> a nombre de <strong>{nombre_cia}</strong> el importe de <strong>${importe} ({importe_escrito})</strong> en las denominaciones de $1,000.00 y $500.00, así mismo solicito que este efectivo sea entregado al Sr. Miguel Ángel Rebuelta Diez en el domicilio ubicado en Callejón de Cuitlahuac No. 160, Col. Lorenzo Boturini, Delegación V. Carranza para lo cual deberá mostrar una identificación vigente al momento de la entrega.</p>
  <p>Referencia {folio} interno.</p>
...
<div id="hoja">
  ...
  <div id="atencion">
    At'n: José Moises García López</div>
  <div id="presente">
    Gerente Caja General
  </div>
