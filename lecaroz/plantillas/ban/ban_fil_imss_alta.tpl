...
<tr>
<td align="center" valign="middle"><p class="title">Alta de Filiales del IMSS </p>
  <form action="./ban_fil_imss_alta.php" method="post" name="form" target="valid">
...
function redir() {
	if (top.mainFrame)
		top.mainFrame.location = './ban_fil_imss_alta.php';
	else
		top.location = './ban_fil_imss_alta.php';
}
