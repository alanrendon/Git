<form action="" method="post" name="modificar" class="FormValidator" id="modificar">
	...
	<table class="table">
		...
		<tbody>
			<tr>
				<td align="left" scope="row" class="bold">Administrador</td>
			...
			<tr>
				...
				<td><input name="email" type="text" class="validate focus toEmail" id="email" value="{email}" size="30" maxlength="70" /></td>
			</tr>
			<tr>
