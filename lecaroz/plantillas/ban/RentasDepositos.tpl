...
<title>Captura de depósitos de renta</title>
...
<script type="text/javascript" src="jscripts/ban/RentasDepositos.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Captura de depósitos de renta</div>
	<div id="captura" align="center">
		<form name="Datos" class="FormValidator FormStyles" id="Datos">
			<table class="tabla_captura">
				...
				<tr>
					<td align="center"><select name="banco" id="banco" style="font-size:16pt;">
