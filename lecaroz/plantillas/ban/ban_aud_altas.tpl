...
<p class="title">ALTA AL CATÁLOGO DE AUDITORES</p>
...
<table class="tabla">
  <tr>
    <th class="vtabla">C&oacute;digo de Auditor</th>
  ...
  <p>
    <img src="./menus/insert.gif" align="middle">&nbsp;&nbsp;<input type="button" name="enviar" class="boton" onclick='valida_registro()' value="Alta de Auditor">
    <br><br>
    <img src="./menus/delete.gif" align="middle">&nbsp;&nbsp;<input type="button" class="boton" onclick='borrar()' value="Borrar formulario">
  </p>
  </form>
</td>
</tr>
