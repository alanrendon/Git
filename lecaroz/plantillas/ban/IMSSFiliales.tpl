...
<title>Filiales para desglose de pagos del IMSS</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/IMSSFiliales.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Filiales para desglose de pagos del IMSS</div><div id="captura" align="center"></div>
</div>
