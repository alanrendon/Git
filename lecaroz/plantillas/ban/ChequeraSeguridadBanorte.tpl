...
<title>Chequera de Seguridad Banorte</title>
...
<script type="text/javascript" src="jscripts/ban/ChequeraSeguridadBanorte.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Chequera de Seguridad Banorte</div>
	<div id="captura" align="center">
		&nbsp;
		<input type="button" name="generar" id="generar" value="Generar archivo" />
	</div>
</div>
