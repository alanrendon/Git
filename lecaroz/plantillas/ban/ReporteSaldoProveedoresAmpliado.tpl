...
<title>Reporte de saldo a proveedores ampliado</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ReporteSaldoProveedoresAmpliado.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de saldo a proveedores ampliado</div>
