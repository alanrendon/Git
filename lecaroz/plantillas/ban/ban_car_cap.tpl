...
<p class="title">Cargos Manuales</p>
<form action="./ban_car_cap.php" method="get" name="form">
<input name="temp" type="hidden">
<table class="tabla">
  <tr>
    <th class="vtabla" scope="row">N&uacute;mero de Cargos </th>
...
<form action="./ban_car_cap.php?tabla={tabla}" method="post" name="form">
<input name="temp" type="hidden">
...
else if (event.keyCode == 40) form.concepto{next}.select();" value="{concepto}" size="45" maxlength="50"></td>
    </tr>
	<!-- END BLOCK : fila -->
  </table>
  <p> 
...
<table width="100%">
  ...
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="60%" class="print_encabezado" align="center">Cargos capturados <br>
...
<table width="100%" class="print">
  ...
  <tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
    ...
    <td class="print" scope="row">{nombre}</td>
