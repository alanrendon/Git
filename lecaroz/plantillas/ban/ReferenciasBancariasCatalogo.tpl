...
<title>Cat&aacute;logo de referencias bancarias</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ReferenciasBancariasCatalogo.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Cat&aacute;logo de referencias bancarias</div><div id="captura" align="center"></div>
</div>
<div id="importar_wrapper" style="display:none;">
	<form name="importar_form" id="importar_form" class="FormValidator">
		<p>Seleccione un archivo CSV: <input name="file[]" type="file" id="file" size="30" multiple /></p>
		<p class="bold red">NOTA: El archivo a importar debe estar en formato CSV, sin encabezados;
		<br />la primera columna debe contener la compa&ntilde;&iacute;a, la segunda columna la referencia bancaria;<br/>cualquier dato extra sera omitido.</p>
	</form>
</div>
