...
<title>Traspaso de saldo entre compañías con-dependencia</title>
...
<script type="text/javascript" src="jscripts/ban/CompaniasCondependenciaTraspasoSaldo.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Traspaso de saldo entre compañías con-dependencia</div>
