...
<p class="title">ALTA DE ADMINISTRADORES</p>
...
<table class="tabla">
  <tr>
    <th class="vtabla">C&oacute;digo de Administrador</th>
  ...
  <p>
    <img src="./menus/insert.gif" align="middle">&nbsp;&nbsp;<input type="button" name="enviar" class="boton" value="Alta de Administrador" onclick='valida_registro()'><br><br>
