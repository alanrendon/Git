...
<title>Consulta de billetes falsos</title>
...
<script type="text/javascript" src="jscripts/ban/BilletesFalsosConsulta.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Consulta de comprobantes de billetes falsos</div>
