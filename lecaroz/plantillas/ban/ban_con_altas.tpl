...
<p class="title">ALTA DE CONTADOR </p>
...
<table class="tabla">
  <tr>
    <th class="vtabla">C&oacute;digo de Contador</th>
  ...
  <p>
    <img src="./menus/insert.gif" align="middle">&nbsp;&nbsp;<input type="button" name="enviar" class="boton" value="Alta de Contador" onclick='valida_registro()'><br><br>
