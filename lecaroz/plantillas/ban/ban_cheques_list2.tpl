...
<form action="./ban_cheques_list2.php" method="get" name="form">
<table class="tabla">
  <tr class="tabla">
...
<table class="print">
  ...
  <tr class="print">
    ...
    <th colspan="8" class="vprint"><font size="2"><strong>{num_cia}&nbsp;{nombre_cia}</strong></font></th>
  </tr>
  <tr class="print">
...
<!-- END BLOCK : folios -->
  <tr class="print">
    <th colspan="8" class="rprint"><font size="2"><strong>TOTAL COMPAÑÍA</strong></font></th>
...
<table class="print" width="80%">
  <tr class="print">
    <th class="vprint" colspan="3"><font size="3"><strong>{num_proveedor}&nbsp;{nombre_proveedor}</strong></font></th>
  </tr>
  <tr class="print">
...
<!-- END BLOCK : reg -->
 ...
 <tr class="print">
	<td colspan="2" class="rprint"><strong>
		Total
	</strong></td> 
