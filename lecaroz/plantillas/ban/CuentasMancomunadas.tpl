...
<title>Cuentas mancomunadas</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/CuentasMancomunadas.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Cuentas mancomunadas</div><div id="captura" align="center"></div>
</div>

<div id="alta_principal_wrapper" style="display:none;">
	<form name="alta_principal_form" class="FormValidator" id="alta_principal_form">
		<table class="table">
			<thead>
				<tr>
					<th colspan="2">&nbsp;</th>
			...
			<tbody>
				<tr>
					<td class="bold" align="left">Principal</td>
					<td>
						<input name="principal" type="text" class="validate focus toPosInt center" id="principal" size="3" />
						<input name="nombre_principal" type="text" id="nombre_principal" size="40" disabled="disabled" />
					</td>
				</tr>
			</tbody>
			<tfoot>
...
<div id="alta_secundaria_wrapper" style="display:none;">
	<form name="alta_secundaria_form" class="FormValidator" id="alta_secundaria_form">
		<table class="table">
			<thead>
				<tr>
					<th colspan="2">&nbsp;</th>
			...
			<tbody>
				<tr>
					<td class="bold" align="left">Secundaria</td>
					<td>
						<input name="secundaria" type="text" class="validate focus toPosInt center" id="secundaria" size="3" />
						<input name="nombre_secundaria" type="text" id="nombre_secundaria" size="40" disabled="disabled" />
					</td>
				</tr>
			</tbody>
			<tfoot>
