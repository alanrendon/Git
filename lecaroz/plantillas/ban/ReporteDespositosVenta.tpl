...
<title>Reporte de dep&oacute;sitos de venta</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ReporteDepositosVenta.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de dep&oacute;sitos de venta</div>
