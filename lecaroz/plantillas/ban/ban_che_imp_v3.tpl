...
<td align="center" valign="middle"><p class="title">Impresi&oacute;n de Cheques</p>
 {mensaje}
  <form action="./ban_che_imp_v3.php" method="get" name="form">
...
<td align="center" valign="middle"><p class="title">El &uacute;ltimo folio capturado no es el consecutivo del &uacute;ltimo cheque generado</p>
  <p>
    <input type="button" class="boton" value="<< Regresar" onClick="document.location='./ban_che_imp_v3.php'">
</p></td>
</tr>
</table>
...
<td align="center" valign="middle"><p class="title">Existen pagos por transferencia electr&oacute;nica pendientes. &iquest;Desea imprimir las p&oacute;lizas? </p>
  <p>
    <input type="button" class="boton" value="No" onClick="document.location='./ban_che_imp_v3.php?no_pol=1'">
&nbsp;&nbsp;    
<input type="button" class="boton" value="Si" onClick="document.location='./ban_che_imp_v3.php?pol=1'">
  </p></td>
</tr>
</table>
<!-- END BLOCK : polizas -->
...
<td align="center" valign="middle"><p style="font-size: 12pt; font-family: Arial, Helvetica, sans-serif; font-weight: bold;">Por favor, inserte las polizas en la impresora (cambiar toner normal). Luego presione el bot&oacute;n Terminar.</p>
  <p>
    <input type="button" class="boton" value="Terminar" onClick="document.location='./ban_che_imp_v3.php'"> 
    </p></td>
</tr>
</table>
<!-- END BLOCK : alert -->
...
<tr>
<td align="center" valign="middle"><p class="title">Impresi&oacute;n de Cheques</p>
  <form action="./ban_che_imp_v3.php" method="post" name="form">
...
<td align="center" valign="middle"><p>{mensaje}</p>
  ...
  <!-- END BLOCK : id -->
  <p>
    <input type="button" class="boton" value="<< Regresar" onClick="document.location='./ban_che_imp_v3.php?ultimo_folio={ultimo_folio}&orden={orden}&cuenta={cuenta}'">
    &nbsp;&nbsp;
...
<p class="title">No hay cheques por imprimir </p>
  <p><input name="button" type="button" class="boton" onClick="document.location='./ban_che_imp_v3.php'" value="<< Regresar"></p></td>
</tr>
</table>
<!-- END BLOCK : no_result -->
</body>
