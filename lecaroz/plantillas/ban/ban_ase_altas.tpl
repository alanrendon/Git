...
<p class="title">ALTA AL CATÁLOGO DE ASEGURADORAS</p>
...
<table class="tabla">
  <tr>
    <th class="vtabla">C&oacute;digo de Aseguradora</th>
  ...
  <p>
    <img src="./menus/insert.gif" align="middle">&nbsp;&nbsp;<input type="button" name="enviar" class="boton" value="Alta de Aseguradora" onclick='valida_registro()'>
    <br><br>
