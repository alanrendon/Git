...
<title>Comparativo de ventas anuales</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ComparativoVentasAnuales.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Comparativo de ventas anuales</div>
