...
<tr>
<td align="center" valign="middle"><p class="title">Diferencia en Saldos</p>
  <form action="./ban_dif_sal_pro.php" method="get" name="form">
...
<table width="100%">
  ...
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="60%" class="print_encabezado" align="center">Diferencia en Saldos <br />
      {mes} {anio} </td>
    <td width="20%">&nbsp;</td>
  </tr>
</table>
...
<table align="center" class="print">
  ...
  <tr>
    ...
    <td class="rprint">{pasivo}</td>
    <td class="rprint">{dif}</td>
  </tr>
  <!-- END BLOCK : fila -->
  <tr>
    <th class="rprint_total">Total</th>
    <th class="rprint_total">{saldo}</th>
    <th class="rprint_total">{pasivo}</th>
