...
<tr>
<td align="center" valign="middle"><p class="title">Efectivos de Rosticerias por Porcentajes </p>
  <form action="./ban_efe_ros.php" method="get" name="form"><table class="tabla">
    <tr>
    ...
    <tr>
      ...
      <td class="vtabla"><input name="anio" type="text" class="insert" id="anio" onFocus="temp.value=this.value" onChange="isInt(this,temp)" onKeyDown="if (event.keyCode == 13) porcentaje.select()" value="{anio}" size="4" maxlength="4"></td>
    </tr>
    <tr>
      <th class="vtabla" scope="row">Porcentaje</th>
      <td class="vtabla"><input name="porcentaje" type="text" class="insert" id="porcentaje" onFocus="temp.value=this.value" onChange="isFloat(this,2,temp)" onKeyDown="if (event.keyCode == 13) num_cia.select()" size="5" maxlength="5"></td>
    </tr>
  </table>  <p>
...
<table width="100%">
  ...
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="60%" class="print_encabezado" align="center">Efectivos de Rosticerias por Porcentajes <br>
...
<table class="print">
  <tr>
    ...
    <th class="print" scope="col"> {por} %</th>
    <th class="print" scope="col">I.V.A. % </th>
  </tr>
  <!-- START BLOCK : fila -->
  <tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
    ...
    <td class="rprint">&nbsp;&nbsp;<font color="#FF0000">{iva}</font>&nbsp;&nbsp;</td>
    <td class="rprint">&nbsp;&nbsp;<font color="#0000FF">{porcentaje}</font>&nbsp;&nbsp;</td>
    <td class="rprint">&nbsp;&nbsp;<font color="#FF0000">{iva_por}</font>&nbsp;&nbsp;</td>
  </tr>
  <!-- END BLOCK : fila -->
  <tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
    ...
    <th class="rprint_total">{iva_por}</th>
  </tr>
</table>
