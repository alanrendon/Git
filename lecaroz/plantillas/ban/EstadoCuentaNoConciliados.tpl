...
<title>Movimientos no concilados</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/EstadoCuentaNoConciliados.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Movimientos no concilados</div>
