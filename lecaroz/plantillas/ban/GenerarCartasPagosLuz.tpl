...
<title>Generar Cartas de Pagos de Luz</title>
...
<script type="text/javascript" src="jscripts/ban/GenerarCartasPagosLuz.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo"> Generar Cartas de Pagos de Luz </div>
