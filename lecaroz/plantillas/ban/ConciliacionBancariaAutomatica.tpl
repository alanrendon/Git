...
<title>Conciliación de movimientos bancarios (automático)</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ban/ConciliacionBancariaAutomatica.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Conciliación de movimientos bancarios (automático)</div>
