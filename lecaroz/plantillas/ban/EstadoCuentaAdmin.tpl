...
<script type="text/javascript" src="/lecaroz/jscripts/ban/EstadoCuentaAdmin.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Modificaci&oacute;n de movimientos bancarios</div>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="hidden" name="tipo_mov" id="tipo_mov" />						<input name="importe" type="text" class="validate focus numberPosFormat right" precision="2" id="importe" size="12" /></td>
				</tr>
				<tr>
