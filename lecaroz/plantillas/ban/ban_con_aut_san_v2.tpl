...
<td align="center" valign="middle"><p class="title">Conciliaci&oacute;n Autom&aacute;tica<br>
    Santander Serfin </p>
  <form action="./ban_con_aut_san_v2.php" method="post" enctype="multipart/form-data" name="form" id="form">
    <table class="tabla">
      <tr>
...
function validar() {
	if (f.userfile.value == "" && confirm('No especifico el archivo de movimientos, ¿desea conciliar de todas maneras?')) {
		document.location = './ban_con_aut_san_v2.php?accion=codsob&hash=xxx';
		return false;
	}
...
<p>
  <input type="button" class="boton" value="Cancelar" onClick="document.location='./ban_con_aut_san_v2.php?accion=cancel&hash={hash}'">
  &nbsp;&nbsp;
  <input type="button" class="boton" value="Siguiente >>" onClick="document.location='./ban_con_aut_san_v2.php?accion=con&hash={hash}'">
</p></td>
</tr>
</table>
...
<td align="center" valign="middle"><p class="title">Conciliaci&oacute;n Autom&aacute;tica<br>
  ...
  <table class="print">
    ...
    <input type="button" class="boton" value="Cancelar" onClick="document.location='./ban_con_aut_san_v2.php?accion=cancel&hash={hash}'">
&nbsp;&nbsp;    
<input name="button" type="button" class="boton" onClick="document.location='./ban_con_aut_san_v2.php?accion=codsob&hash={hash}'" value="Siguiente >>">
</p></td>
</tr>
</table>
<!-- END BLOCK : imp -->
...
<td align="center" valign="middle"><p class="title">Conciliaci&oacute;n Autom&aacute;tica<br>
    Santander Serf&iacute;n</p>
  <form action="./ban_con_aut_san_v2.php?accion=con&hash={hash}" method="post" name="form"><table class="tabla">
    <tr>
...
<td align="center" valign="middle"><p class="title">Saldos Bajos</p>
  ...
  <p>
    <input type="button" class="boton" value="Continuar" onClick="document.location='./ban_con_aut_san_v2.php?accion=res'">
  </p>  <p>&nbsp; </p></td>
</tr>
</table>
<!-- END BLOCK : saldos -->
