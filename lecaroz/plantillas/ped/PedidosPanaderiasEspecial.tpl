...
<title>Pedidos de Panaderías Especial</title>
...
<script type="text/javascript" src="jscripts/ped/PedidosPanaderiasEspecial.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Pedidos de Panaderías Especial</div>
