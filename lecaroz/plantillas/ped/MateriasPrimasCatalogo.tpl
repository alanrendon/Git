...
<script type="text/javascript" src="/lecaroz/jscripts/mootools/Request.File.js"></script>
<script type="text/javascript" src="menus/stm31.js"></script>
<script type="text/javascript" src="jscripts/ped/MateriasPrimasCatalogo.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Catálogo de productos de materia prima</div>
