...
<title>Existencia estimada mayor al consumo mensual</title>
...
<script type="text/javascript" src="jscripts/ped/ExistenciaEstimadaInventario.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Existencia estimada mayor al consumo mensual</div>
