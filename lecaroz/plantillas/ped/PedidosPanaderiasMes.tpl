...
<title>Pedidos de Panaderías Mensual</title>
...
<script type="text/javascript" src="jscripts/ped/PedidosPanaderiasMes.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Pedidos de Panaderías Mensual</div>
