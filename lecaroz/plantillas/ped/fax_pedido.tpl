...
<table width="100%">
  <tr>
    <td>&nbsp;</td>
    <td align="center" class="print_encabezado"><span class="style7">Oficinas Administrativas Mollendo S. de R.L. y C.V. </span></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="60%" align="center" class="print_encabezado"><span class="style7">Pedido de Materias Primas <br>
