...
<title>Asignación de productos por proveedor</title>
...
<script type="text/javascript" src="jscripts/ped/DistribucionProductosProveedores.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Asignación de Productos por Proveedor</div>
		...
		<form name="Datos" class="FormValidator FormStyles" id="Datos">
			<table class="tabla_captura">
				...
				<tr class="linea_on">
					...
					<td><input name="tipo" type="radio" id="radio" value="1" />
						Por producto
						<input name="tipo" type="radio" id="radio2" value="2" checked="checked" />
						Por compañía</td>
				</tr>
			</table>
			<p>
