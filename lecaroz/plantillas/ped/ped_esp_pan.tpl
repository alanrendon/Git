...
<tr>
<td align="center" valign="middle"><p class="title">Enviar inventarios de pedido especial a las panaderias</p>
  <form action="ped_esp_pan.php" method="get" name="form">
...
function validar() {
	if (confirm("Cualquier inventario pasara hasta que la panaderia haga su actualziación.\n¿Desea generar los inventarios de fin de mes?"))
		f.submit();
}
