...
<td align="center" valign="middle"><p class="title">Impresi&oacute;n de Faxes de Pedidos </p>
  <form action="./ped_imp_fax_v2.php" method="get" name="form" target="fax">
...
<script language="javascript" type="text/javascript">
	function valida_registro(form) {
		/*if (confirm("¿Son correctos los datos?")) {
			...
			form.num_cia.select();*/
		var ventana = window.open("","fax","toolbar=no,location=no,directories=no,status=no,menubar=yes,scrollbars=yes,resizable=no,width=800,height=600");
		ventana.focus();
		form.submit();
	}
