...
<script type="text/javascript" src="jscripts/AlertaTrabajadoresContratosVencidos.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<p class="bold font14 center noDisplay">Contratos de trabajadores vencidos</p>
