...
<p class="title">Precios de Compra</p>
<table class="tabla">
  <tr>
...
<br>
<form name="form" method="post" action="./ros_prc_minimod.php?tabla={tabla}">
...
<table class="tabla">
  ...
  <!-- START BLOCK : fila -->
  <tr>
    <td class="tabla"><input name="codmp{i}" type="text" class="insert" id="codmp{i}" onFocus="form.temp.value=this.value" onChange="if (isInt(this,form.temp)) actualiza_mp(this,form.nombre{i},form.precio_actual{i},form.precio_compra{i})" onKeyDown="if (event.keyCode == 13 || event.keyCode == 39) form.precio_compra{i}.select();
else if (event.keyCode == 37) form.precio_compra{back}.select();
    ...
    <td class="tabla"><input name="precio_compra{i}" type="text" class="rinsert" id="precio_compra{i}" onFocus="form.temp.value=this.value" onChange="if (isFloat(this,2,form.temp)) return true;" onKeyDown="if (event.keyCode == 13 || event.keyCode == 39) form.codmp{next}.select();
else if (event.keyCode == 37) form.codmp{i}.select();
else if (event.keyCode == 38) form.precio_compra{back}.select();
else if (event.keyCode == 40) form.precio_compra{next}.select();" size="10" maxlength="10"></td>
  </tr>
  <!-- END BLOCK : fila -->
</table>
