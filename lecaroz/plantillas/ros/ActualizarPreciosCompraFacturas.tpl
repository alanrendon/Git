...
<script type="text/javascript" src="jscripts/ros/ActualizarPreciosCompraFacturas.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Actualizar Precios de Compra de Facturas </div>
  <div id="captura" align="center">
    <form name="Datos" class="formulario" id="Datos">
      ...
      <tr>
        ...
        <td class="linea_off"><input name="codmp" type="text" class="cap toPosInt alignCenter" id="codmp" size="1" />
          <input name="nombre_mp" type="text" class="disabled" id="nombre_mp" size="30" /></td>
      </tr>
      <tr>
        <th align="left">Precio de Compra </th>
        <td class="linea_on"><input name="precio_compra" type="text" class="cap numPosFormat2" id="precio_compra" size="10" /></td>
      </tr>
    </table>
      <p>
