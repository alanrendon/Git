...
<title>Cat&aacute;logo de porcentaje de facturas por d&iacute;a</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ros/RosticeriasCatalogoDistribucionSemanal.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Cat&aacute;logo de porcentaje de facturas por d&iacute;a</div><div id="captura" align="center"></div>
</div>
