...
<title>Precios de compra y venta de rosticer&iacute;as</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ros/RosticeriasPreciosCompraVenta.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Precios de compra y venta de rosticer&iacute;as</div><div id="captura" align="center"></div>
</div>
