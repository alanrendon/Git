...
<title>Reporte de kilos comprados de productos de rosticer&iacute;a</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ros/KilosPolloPeriodo.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de kilos comprados de productos de rosticer&iacute;a</div>
