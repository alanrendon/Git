...
<title>Reporte de compras y ventas de productos de rosticer&iacute;a anual</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ros/CompraPolloAnual.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de compras y ventas de productos de rosticer&iacute;a anual</div>
