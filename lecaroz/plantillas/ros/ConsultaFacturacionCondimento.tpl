...
<title>Consulta de Facturaci&oacute;n de Condimento</title>
...
<div id="contenedor">
  ...
  <div id="captura" align="center">
    <form action="ConsultaFacturacionCondimento.php" method="post" name="Datos" target="result" class="formulario" id="Datos">
      <input name="accion" type="hidden" id="accion" value="consultar" />
