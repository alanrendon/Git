...
<title>Consulta de compras de rosticer&iacute;a</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/ros/RosticeriasFacturasConsulta.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Consulta de compras de rosticer&iacute;a</div>
