...
<tr>
<td align="center" valign="middle"><p class="title">Asuntos Pendientes</p>
  <table class="tabla">
    <tr>
      <th class="tabla" scope="col">Compa&ntilde;&iacute;a</th>
      <th class="tabla" scope="col">Folio</th>
      <th class="tabla" scope="col">Fecha</th>
      <th class="tabla" scope="col">Respuesta</th>
	...
	<tr>
      ...
      <td class="vtabla">{folio}</td>
      <td class="tabla">{fecha}</td>
      <td class="tabla">{fecha_respuesta}</td>
