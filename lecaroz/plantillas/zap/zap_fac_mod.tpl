...
<td align="center" valign="middle"><p class="title">Modificaci&oacute;n de Facturas 
  ...
  <form action="./zap_fac_mod.php" method="get" name="form">
    ...
    <tr>
      ...
      <td class="vtabla"><input name="num_fact" type="text" class="insert" id="num_fact" onfocus="tmp.value=this.value;this.select()" onchange="isInt(this,tmp)" onkeydown="if (event.keyCode == 13) num_pro.select()" size="5" /></td>
      </tr>
  </table>  
  <p>
...
<td align="center" valign="middle"><p class="title">Modificaci&oacute;n de Facturas</p>
  <form action="./zap_fac_mod.php" method="post" name="form">
    <input name="tmp" type="hidden" id="tmp" />
    ...
    <tr>
      ...
      <input name="num_pro" type="text" class="insert" id="num_pro" onfocus="tmp.value=this.value;this.select()" onchange="if (isInt(this,tmp)) cambiaPro()" onkeydown="movCursor(event.keyCode,clave,null,clave,num_cia,num_fact)" value="{num_proveedor}" size="3" />
        <input name="nombre_pro" type="text" disabled="disabled" class="vnombre" id="nombre_pro" style="font-size:12pt;" value="{nombre_pro}" size="45" />
	...
	<tr>
	  ...
	  <td colspan="2" class="tabla"><input name="con_dif_precio" type="text" class="vinsert" id="con_dif_precio" onfocus="this.select()" onkeydown="movCursor(event.keyCode,dif_precio,null,dif_precio,con_desc4,con_desc1)" value="{con_dif_precio}" maxlength="100" /></td>
	  <td class="rtabla"><input name="dif_precio" type="text" class="rinsert" id="dif_precio" onfocus="tmp.value=this.value;this.select()" onchange="if (inputFormat(this,2,true)) calculaTotal()" onkeydown="movCursor(event.keyCode,con_desc1,con_dif_precio,null,desc4,desc1)" value="{dif_precio}" /></td>
	  </tr>
	  <tr>
	  <td colspan="5" class="tabla" scope="row">&nbsp;</td>
	  </tr>
    ...
    <tr>
      ...
      <th colspan="4" class="rtabla" scope="row"><input name="pivaret" type="text" class="rinsert" id="fletes5" onfocus="tmp.value=this.value;this.select()" onchange="if (isFloat(this,2,tmp)) calculaTotal()" onkeydown="movCursor(event.keyCode,fletes,null,null,pisr,fletes)" value="{pivaret}" size="5" maxlength="5" />
...
window.onload = function() { showAlert = true; calculaTotal(); f.num_cia.select(); };
//-->
</script>
<!-- END BLOCK : mod -->
<!-- START BLOCK : close -->
