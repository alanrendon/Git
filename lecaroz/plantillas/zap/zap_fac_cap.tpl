...
<td align="center" valign="middle"><p class="title">Captura de Facturas</p>
  <form action="./zap_fac_cap.php" method="post" name="form">
    ...
    <tr>
      ...
      <td class="vtabla" colspan="3"><input name="fecha_rec" type="text" class="insert" id="fecha_rec" onfocus="tmp.value=this.value;this.select()" onchange="inputDateFormat(this)" onkeydown="movCursor(event.keyCode,fecha_inv,null,null,fecha,fecha_inv)" value="{fecha_rec}" size="10" maxlength="10" /></td>
    </tr>
    <tr>
...
function sucursales() {
	...
	// Pedir datos
	myConn.connect("./zap_fac_cap.php", "GET", 'matriz=' + get_val(f.num_cia), resultSuc);
}
