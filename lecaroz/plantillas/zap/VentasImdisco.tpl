...
<script type="text/javascript" src="jscripts/zap/VentasImdisco.js"></script>
<script type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Ventas de Imdisco</div>
			...
			<table class="tabla_captura">
				...
				<tfoot>
					<tr>
						...
						<th align="right" id="total">0.00</th>
					</tr>
				</tfoot>
			</table>
			<p>
				<input type="button" name="registrar" id="registrar" value="Registrar ventas" />
			</p>
		</form>
	</div>
</div>
