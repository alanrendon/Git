    ...
    <form name="Datos" class="formulario" id="Datos">
      <table class="tabla_captura">
        ...
        <tr>
          ...
          <td class="linea_off"><input name="pros_sin_pago" type="text" class="cap toInterval" id="pros_sin_pago" size="30" /></td>
        </tr>
        <tr>
          <th align="left" scope="row">Compa&ntilde;&iacute;as que no pagaran </th>
          <td class="linea_on"><input name="cias_no_pago" type="text" class="cap toInterval" id="cias_no_pago" size="30" /></td>
        </tr>
        <tr>
          <th align="left" scope="row">Pagos obligatorios </th>
          <td class="linea_off"><input name="pagos_obligados" type="text" class="cap toInterval" id="pagos_obligados" size="30" /></td>
        </tr>
        <tr>
          <th align="left" scope="row">N&uacute;mero de cheques </th>
          <td class="linea_on"><input name="num_cheques" type="text" class="cap numberPosFormat alignRight" id="num_cheques" size="5" /></td>
        </tr>
      </table>
      <p>
...
<!-- START BLOCK : facturas -->
    <form name="Facturas" class="formulario" id="Facturas">
	  ...
	  <table class="tabla_captura">
        <tr>
          <th colspan="7" align="left" scope="col"><input name="checkall" type="checkbox" id="checkall" checked="checked" />
        ...
        <tr>
          <td colspan="7" align="left" scope="col">&nbsp;</td>
        </tr>
        <!-- START BLOCK : cia -->
		  <tr>
          <th colspan="7" align="left" class="font12" scope="col">{num_cia} {nombre} </th>
        </tr>
        <!-- START BLOCK : saldo -->
		  <tr style="background-color:#{color_banco};">
          <td colspan="5" class="bold" align="right" scope="col">{banco} </td>
          <td colspan="2" align="right" class="bold" scope="col">{saldo}</td>
        </tr>
		  <!-- END BLOCK : saldo -->
		  <tr style="background-color:#{color_banco};">
		    <th colspan="5" class="font12" align="right" scope="col">Saldo para pagar </th>
        ...
        <!-- START BLOCK : row -->
		  <tr style="background-color:#{color_banco};">
          <td align="center"><input name="id[]" type="checkbox" id="id" alt="{num_cia}" value="{id}" checked="checked" /></td>
        ...
        <tr>
		  ...
		  <!-- END BLOCK : cia -->
        <tr>
          <th colspan="5" align="right" class="font16">Total a pagar </th>
          <th id="gran_total" align="right" class="font16">{total}</th>
          <th id="gran_total" align="right" class="font16">&nbsp;</th>
        </tr>
        <tr>
          <th colspan="5" align="right" class="font16">N&uacute;mero de Facturas </th>
