...
<title>Historico de balances</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/BalancesHistorico.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Historico de balances</div>
