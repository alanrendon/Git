...
<title>Comparativo de efectivos contra gastos varios</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ComparativoEfectivosGastosVarios.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Comparativo de efectivos contra gastos varios</div>
