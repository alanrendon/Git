...
<script language="javascript" type="text/javascript">
	function cerrar() {
		window.opener.document.location = "./bal_act_inv.php?tipo={tipo}&rango={rango}#{num_cia}";
		window.opener.onload = window.opener.document.location.reload();
		self.close();
	}
...
<form name="form" method="post" action="./bal_ifm_minimod.php?tabla={tabla}">
<input name="temp" type="hidden">
<input name="id" type="hidden" value="{id}">
<input name="tipo" type="hidden" id="tipo" value="{tipo}">
<input name="rango" type="hidden" id="rango" value="{rango}">
<table class="tabla">
  <tr>
  ...
  <tr>
    ...
    <td class="tabla"><input name="inventario" type="text" class="insert" id="inventario" onFocus="form.temp.value=this.value" onChange="isInt(this,form.temp)" value="{inventario}" size="10" maxlength="10"></td>
  </tr>
</table>
<p>
