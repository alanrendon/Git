...
<title>Comparativo de efectivos contra I.V.A.</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ComparativoEfectivosIVA.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Comparativo de efectivos contra I.V.A.</div>
