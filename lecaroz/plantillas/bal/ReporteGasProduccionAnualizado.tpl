...
<title>Porcentajes de gas contra producci&oacute;n</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteGasProduccionAnualizado.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Porcentajes de gas contra producci&oacute;n</div>
