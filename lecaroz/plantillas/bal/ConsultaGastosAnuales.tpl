...
<title>Consulta de Gastos Anuales</title>
...
<script type="text/javascript" src="jscripts/bal/ConsultaGastosAnuales.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Consulta de Gastos Anuales </div>
    ...
    <form name="Datos" class="FormValidator FormStyles" id="Datos">
      <table class="tabla_captura">
        ...
        <tr class="linea_off">
          ...
          <td><input name="anio" type="text" class="valid Focus toPosInt center" id="anio" value="{anio}" size="10" maxlength="10" /></td>
        </tr>
      </table>
      <br />
      <p>
