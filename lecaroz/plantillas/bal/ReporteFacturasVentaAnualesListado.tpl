...
<title>Reporte de facturas de venta anual</title>
...
<script type="text/javascript" src="jscripts/bal/ReporteFacturasVentaAnualesListado.js"></script>
<style type="text/css">
#info_tip {
...
<table width="98%" align="center" class="encabezado">
  <tr>
    <td width="100%" align="center">Reporte de facturas de venta del a&ntilde;o {anio}</td>
  </tr>
</table>
<br />
