...
<title>Reporte de facturas de compra anuales</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteFacturasCompraAnualesInicio.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Reporte de facturas de compra anuales</div>
