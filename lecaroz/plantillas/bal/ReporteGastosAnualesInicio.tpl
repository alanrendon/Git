...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteGastosAnualesInicio.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Reporte de gastos anuales</div>
		...
		<form name="Datos" class="FormValidator" id="inicio">
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<td align="left" class="bold" scope="row">Gasto</td>
						<td><input name="gasto" type="text" class="validate focus toPosInt right" id="gasto" size="3" />
						<input name="descripcion" type="text" id="descripcion" size="40" readonly="readonly" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td align="left" class="bold" scope="row">Filtro</td>
						<td>
							<input name="filtro" type="radio" id="filtro_0" value="" checked="checked"> Todos
							<br /><input name="filtro" type="radio" id="filtro_1" value="NULL"> Solo gastos
							<br /><input name="filtro" type="radio" id="filtro_2" value="NOT NULL"> Solo cheques
						</td>
					</tr>
				</tbody>
				<tfoot>
