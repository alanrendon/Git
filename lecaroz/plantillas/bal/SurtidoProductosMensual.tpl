...
<title>Surtido de productos mensual</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/SurtidoProductosMensual.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Surtido de productos mensual</div>
		...
		<form name="inicio" class="FormValidator" id="inicio">
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<td align="left" class="bold" scope="row">Producto</td>
						<td><input name="codmp" type="text" class="validate focus toPosInt right" id="codmp" size="3" />
						<input name="nombre_mp" type="text" id="nombre_mp" size="40" readonly="readonly" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td align="left" class="bold" scope="row">Mes</td>
