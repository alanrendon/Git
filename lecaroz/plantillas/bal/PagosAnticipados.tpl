...
<script type="text/javascript" src="/lecaroz/jscripts/bal/PagosAnticipados.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Pagos anticipados</div><div id="captura" align="center"></div>
</div>
