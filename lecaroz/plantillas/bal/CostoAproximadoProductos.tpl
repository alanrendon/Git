...
<title>Costo aproximado de productos</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/CostoAproximadoProductos.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Costo aproximado de productos</div><div id="captura" align="center"></div>
</div>
