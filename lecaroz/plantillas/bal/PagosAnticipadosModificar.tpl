<form name="modificar_pago" class="FormValidator" id="modificar_pago">
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td><input name="concepto" type="text" class="validate toText cleanText toUpper" id="concepto" size="40" maxlength="100" value="{concepto}" /></td>
			</tr>
			<tr>
				<td class="bold">Importe</td>
				<td><input name="importe" type="text" class="validate focus numberFormat right" precision="2" id="importe" size="10" value="{importe}" /></td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
