...
<table width="100%">
  ...
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="60%" class="print_encabezado" align="center">Hist&oacute;rico de Balances del {anio} </td>
    <td width="20%">&nbsp;</td>
  </tr>
</table>
<br>
...
<table width="100%" cellpadding="0" cellspacing="0" class="print">
    <tr>
      <th width="100" class="print" scope="col">{mes}</th>
    </tr>
    <tr>
    ...
    <tr>
      <td class="rprint">{gastos_caja_total}</td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="rprint" style="color:#C00">{saldo_ini}</td>
    </tr>
    <tr>
      <td class="rprint" style="color:#00C">{saldo_fin}</td>
    </tr>
    <tr>
      <td class="rprint" style="color:#C00">{saldo_pro_ini}</td>
    </tr>
    <tr>
      <td class="rprint" style="color:#00C">{saldo_pro_fin}</td>
    </tr>
    <tr>
      <td class="rprint" style="color:#C00">{no_inc}</td>
    </tr>
    <tr>
      <td class="rprint" style="color:#00C">{dif_res}</td>
    </tr>
    <tr>
      <td class="rprint" style="color:#C00">{dif_inv}</td>
    </tr>
    <tr>
      <td class="rprint" style="color:#00C">{dif}</td>
    </tr>
</table>
	</td>
	<!-- END BLOCK : col_pan -->
