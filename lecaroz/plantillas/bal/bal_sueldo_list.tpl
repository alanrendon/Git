...
<tr>
<td align="center" valign="middle"><p class="title">Listado de Sueldos pagados </p>
  <form action="./bal_sueldo_list.php" method="get" name="form" onKeyPress="if (event.keyCode == 13) return false">
...
<table width="100%">
  ...
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="60%" class="print_encabezado" align="center">Sueldos pagados  del {anio} <br>      </td>
    <td width="20%">&nbsp;</td>
  </tr>
</table>
  <br>
