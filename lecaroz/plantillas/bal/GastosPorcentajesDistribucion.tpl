...
<title>Porcentajes de distribuci&oacute;n de gastos</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/GastosPorcentajesDistribucion.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Porcentajes de distribuci&oacute;n de gastos</div>
