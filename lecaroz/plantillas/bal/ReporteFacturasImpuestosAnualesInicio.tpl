...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteFacturasImpuestosAnualesInicio.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Reporte de impuestos de facturas anual</div>
