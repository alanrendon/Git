...
<title>Reporte de efectivos anuales</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteEfectivosAnualesInicio.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Reporte de efectivos anuales</div>
