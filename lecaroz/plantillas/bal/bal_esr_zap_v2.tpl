...
<tr>
<td align="center" valign="middle"><p class="title">Balances de Zapater&iacute;as </p>
...
function generar() {
	...
	myConn.connect("./generar_balance_zap.php", "GET", opt, Status);
}
...
function imprimir() {
	...
	var win = window.open('balance_zap.php?' + opt, 'balances_zap','toolbar=no,location=no,directories=no,status=no,menubar=yes,scrollbars=yes,resizable=yes,width=1024,height=768');
	win.focus();
}
