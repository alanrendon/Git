...
<td align="center" valign="middle"><p class="title">Estimaci&oacute;n Anual </p>
  <form action="./bal_com_nombal.php" method="get" name="form">
...
<table align="center" class="print">
  <tr>
    ...
    <th class="print" scope="col">Nomina</th>
    <th class="print" scope="col">Saldo Actual </th>
    <th class="print" scope="col">General</th>
    <th class="print" scope="col">Diferencia</th>
    <th class="print" scope="col">Promedio Mensual </th>
    <th class="print" scope="col">Promedio Diario</th>
  </tr>
  <!-- START BLOCK : fila -->
  <tr onMouseOver="overTR(this,'#ACD2DD');" onMouseOut="outTR(this,'');">
    ...
    <td class="rprint">{prom_mes}</td>
    <td class="rprint">{prom_dia}</td>
  </tr>
  <!-- END BLOCK : fila -->
</table>
{salto}
