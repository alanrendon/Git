...
<title>Reporte de inventario anualizado</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteInventarioAnualizado.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de inventario anualizado</div>
