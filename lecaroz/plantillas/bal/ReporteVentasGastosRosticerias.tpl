...
<title>Reporte de ventas y gastos de rosticer&iacute;as</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteVentasGastosRosticerias.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de ventas y gastos de rosticer&iacute;as</div>
