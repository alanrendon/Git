...
<head>
	...
	<title>Comparativo de conceptos de balance</title>
	...
	<script type="text/javascript" src="/lecaroz/jscripts/bal/BalancesComparativoDatosAnual.js"></script>
	<style type="text/css">
		.icono {
			opacity: 0.6;
		}
...
<body>
	...
	<div id="contenedor">
		<div id="titulo">Comparativo de conceptos de balance</div>
	...
	<div id="graficas_wrapper" style="display:none; width:800px; height:600px;">
		<iframe id="graficas_frame" src="" style="width:100%; height:100%;"></iframe>
	</div>
