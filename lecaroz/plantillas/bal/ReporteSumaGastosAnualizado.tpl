...
<head>
	...
	<title>Reporte de gastos totalizados anuales</title>
	...
	<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteSumaGastosAnualizado.js"></script>
	<style type="text/css">
		.info-table {
...
<body>
	...
	<div id="contenedor">
		<div id="titulo">Reporte de gastos totalizados anuales</div>
