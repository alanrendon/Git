...
<script type="text/javascript" src="jscripts/bal/ComparativoPiezasProducidas.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Comparativo de piezas producidas</div>
  <!-- START BLOCK : normal -->
    ...
    <form name="Datos" class="FormValidator FormStyles" id="Datos">
      <table class="tabla_captura">
        ...
        <tr class="linea_off">
        	...
        	<td><input name="anio" type="text" class="valid Focus toDate center" id="anio" value="{anio}" size="4" maxlength="4" /></td>
        	</tr>
        <tr class="linea_on">
