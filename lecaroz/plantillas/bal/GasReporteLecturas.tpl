...
<title>Reporte de consumos de gas</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/GasReporteLecturas.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de consumos de gas</div>
