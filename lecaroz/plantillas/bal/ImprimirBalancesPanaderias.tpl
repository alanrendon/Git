...
<title>Balances de Panader&iacute;as</title>
...
<script type="text/javascript" src="jscripts/bal/ImprimirBalancesPanaderias.js"></script>
...
<!-- START BLOCK : normal -->
<div id="contenedor">
  <div id="titulo"> Balances de Panader&iacute;as </div>
