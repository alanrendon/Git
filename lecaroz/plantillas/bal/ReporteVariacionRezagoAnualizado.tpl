...
<title>Reporte de variaci&oacute;n de rezagos anualizado</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReporteVariacionRezagoAnualizado.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reporte de variaci&oacute;n de rezagos anualizado</div>
