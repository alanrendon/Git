...
<title>Reserva de gastos para balance</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/bal/ReservaGastos.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Reserva de gastos para balance</div><div id="captura" align="center"></div>
</div>
