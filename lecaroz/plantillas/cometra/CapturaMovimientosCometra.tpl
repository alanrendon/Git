...
<title>Captura de Movimientos de Cometra </title>
...
<script type="text/javascript" src="jscripts/cometra/CapturaMovimientosCometra.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo"> Captura de Movimientos de Cometra </div>
    ...
    <form name="Datos" class="FormValidator FormStyles" id="Datos">
      ...
      <table class="tabla_captura">
		...
		<tr>
          ...
          <input name="descripcion[]" type="text" disabled="disabled" class="disabled" id="descripcion" size="10" /></td>
