<form name="Datos" class="FormValidator FormStyles" id="Datos">
  ...
  <table class="tabla_captura">
	...
	<tr class="linea_off">
	  ...
	  <input name="nombre_cia[]" type="text" disabled id="nombre_cia" value="{nombre_cia}" size="30" /></td>
	  <td><input name="cod_mov[]" type="text" class="valid Focus toPosInt center" id="cod_mov" value="{cod_mov}" size="3" />
	  <input name="descripcion[]" type="text" disabled id="descripcion" value="{descripcion}" size="9" /></td>
	...
	<tr>
	  ...
	  <th><input name="total" type="text" disabled="disabled" class="right bold" id="total" value="{total}" size="10" /></th>
	</tr>
  </table>
  <p>
