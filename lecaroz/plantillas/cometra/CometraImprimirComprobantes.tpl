...
<title>Imprimir comprobantes de Cometra</title>
...
<script type="text/javascript" src="jscripts/cometra/CometraImprimirComprobantes.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Imprimir comprobantes de Cometra</div>
	<div id="captura" align="center">
		<form action="" method="post" name="Datos" class="FormValidator FormStyles" id="Datos">
			...
			&nbsp;&nbsp;
			<input type="button" name="generar" id="generar" value="Generar" />
			</p>
		</form>
	</div>
</div>
