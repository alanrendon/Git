...
<title>Cat&aacute;logo de Compa&ntilde;&iacute;as</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/fac/CompaniasCatalogo.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Cat&aacute;logo de Compa&ntilde;&iacute;as</div><div id="captura" align="center"></div>
</div>
