...
<title>Facturas Electr&oacute;nicas de Venta Diaria (Autom&aacute;tico)</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/fac/FacturasElectronicasVentaDiariaAutomaticoV2.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<div id="contenedor">
	<div id="titulo">Facturas Electr&oacute;nicas de Venta Diaria (Autom&aacute;tico)</div>
