...
<p class="title">CONSULTA AL CAT&Aacute;LOGO DE TURNOS </P>
<form name="form" method="post" action="./fac_tur_mod.php?tabla={tabla}" onKeyDown="if (event.keyCode == 13) document.form.enviar.focus();">
  <br>
<table class="tabla">
    <tr class="rtabla">
      ...
      <th class="tabla" align="center">Descripci&oacute;n del turno </th>
