...
<tr>
<td align="center" valign="middle"><p class="title">Alta de Compa&ntilde;&iacute;a</p>
  <form action="./fac_cia_altas_v2.php" method="post" name="form"><input name="tmp" type="hidden" id="tmp">
    <input name="status" type="hidden" id="status" value="TRUE"> 
    <input name="homo_clave" type="hidden" id="homo_clave2" value="TRUE">
  <table class="tabla">
    <tr>
      <th class="vtabla">Compa&ntilde;&iacute;a</th>
      <td class="vtabla" onMouseOver="overTD(this,'#ACD2DD');" onMouseOut="outTD(this,'');"><input name="num_cia" type="text" class="insert" id="num_cia" onFocus="tmp.value=this.value;this.select()" onChange="isInt(this,tmp)" onKeyDown="if (event.keyCode == 13) nombre.select()" value="{num_cia}" size="3" maxlength="3"></td>
      <th class="vtabla">Tipo de persona</th>
      <td class="vtabla" onMouseOver="overTD(this,'#ACD2DD');" onMouseOut="outTD(this,'');"><input name="persona_fis_moral" type="radio" value="FALSE" {per_false}>
        Moral&nbsp;&nbsp;
        <input name="persona_fis_moral" type="radio" value="TRUE" {per_true}>
        F&iacute;sica</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="vtabla" onMouseOver="overTD(this,'#ACD2DD');" onMouseOut="outTD(this,'');"><input name="med_agua" type="radio" value="TRUE" {agua_true}>
        Si
          &nbsp;
          <input name="med_agua" type="radio" value="FALSE" {agua_false}>
          No</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="vtabla" onMouseOver="overTD(this,'#ACD2DD');" onMouseOut="outTD(this,'');"><input name="aplica_iva" type="radio" value="TRUE" {iva_true}>
        Si&nbsp;&nbsp;
        <input name="aplica_iva" type="radio" value="FALSE" {iva_false}>
        No</td>
    ...
    <tr>
      ...
      <td class="vtabla" onMouseOver="overTD(this,'#ACD2DD');" onMouseOut="outTD(this,'');"><input name="cliente_cometra" type="text" class="vinsert" id="cliente_cometra2" onFocus="tmp.value=this.value;this.select()" onChange="isInt(this,tmp)" onKeyDown="if (event.keyCode == 13) dia_ven_luz.select()" value="{cliente_cometra}" size="10"></td>
    </tr>
    <tr>
      ...
      <td class="vtabla" onMouseOver="overTD(this,'#ACD2DD');" onMouseOut="outTD(this,'');"><input name="aviso_saldo" type="radio" value="FALSE" {saldo_false}>
        No
          <input name="aviso_saldo" type="radio" value="TRUE" {saldo_true}>
          Si</td>
    </tr>
    <tr>
      <th class="vtabla">Dia de vencimiento de recibo de luz </th>
    ...
    <tr>
    	...
    	<td class="vtabla" onMouseOver="overTD(this,'#ACD2DD');" onMouseOut="outTD(this,'');"><input name="turno_cometra" type="radio" id="turno_cometra_2" value="1" checked>
    		Matutino
    			<input type="radio" name="turno_cometra" id="turno_cometra_1" value="2">
    			Vespertino</td>
    	<th class="vtabla">&nbsp;</th>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="vtabla"><input name="clabe_banco2" type="text" class="vinsert" id="clabe_banco2" onFocus="this.select()" onKeyDown="if (event.keyCode == 13) clabe_plaza2.select()" value="{banco2}" size="3" maxlength="3">
...
function validar() {
	...
	else if (f.nombre_corto.value.length < 5) {
