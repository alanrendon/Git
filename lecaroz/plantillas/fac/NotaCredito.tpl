...
<script type="text/javascript" src="jscripts/fac/NotaCredito.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Nota de Cr&eacute;dito</div>
  <div id="captura" align="center">
    <form action="" method="post" name="Datos" class="FormValidator FormStyles" id="Datos">
      ...
      <table class="tabla_captura">
        <tr>
          <th colspan="5" align="left" scope="col"><img src="imagenes/info.png" width="16" height="16" /> Factura donde aplica la nota de cr&eacute;dito</th>
        </tr>
        <tr>
        ...
        <tr class="linea_off">
          <td align="center"><input name="num_cia_factura" type="text" class="valid Focus toPosInt center" id="num_cia_factura" size="3" />
          <input name="nombre_cia_factura" type="text" disabled="disabled" id="nombre_cia_factura" size="30" /></td>
          <td align="center"><input name="num_factura" type="text" class="valid Focus toPosInt center" id="num_factura" size="10" /></td>
          <td align="center"><input name="fecha_factura" type="text" disabled="disabled" class="center" id="fecha_factura" size="10" maxlength="10" /></td>
          <td align="center"><input name="total_factura" type="text" disabled="disabled" class="right" id="total_factura" size="10" /></td>
          <td align="center"><input name="porcentaje_descuento_factura" type="text" class="valid Focus numberPosFormat right" precision="2" id="porcentaje_descuento_factura" size="5" /></td>
        </tr>
      </table>
<br />
      <table class="tabla_captura">
