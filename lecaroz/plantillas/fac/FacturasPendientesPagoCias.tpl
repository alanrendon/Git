...
<script type="text/javascript" src="/lecaroz/jscripts/fac/FacturasPendientesPagoCias.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Facturas pendientes de pago</div><div id="captura" align="center"></div>
</div>
