...
<title>Series para Facturaci&oacute;n Electr&oacute;nica</title>
...
<script type="text/javascript" src="jscripts/fac/FacturasElectronicasSeries.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Series para Facturaci&oacute;n Electr&oacute;nica</div>
