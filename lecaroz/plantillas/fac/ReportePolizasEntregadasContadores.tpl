...
<script type="text/javascript" src="/lecaroz/jscripts/fac/ReportePolizasEntregadasContadores.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Reporte de p&oacute;lizas entregadas a contadores</div><div id="captura" align="center"></div>
</div>
