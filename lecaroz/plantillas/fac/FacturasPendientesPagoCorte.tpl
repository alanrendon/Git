...
<title>Facturas de proveedores pendientes de pago al corte</title>
...
<script type="text/javascript" src="jscripts/fac/FacturasPendientesPagoCorte.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Facturas de proveedores pendientes de pago al corte</div>
		...
		<form action="" method="post" name="Datos" class="FormValidator FormStyles" id="Datos">
			<table class="tabla_captura">
				...
				<tr class="linea_on">
					...
					<td><input name="fecha_corte" type="text" class="valid Focus toDate center" id="fecha_corte" value="{fecha_corte}" size="10" maxlength="10" /></td>
				</tr>
			</table>
			<p>
