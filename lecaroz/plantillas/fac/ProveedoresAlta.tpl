...
<script type="text/javascript" src="jscripts/fac/ProveedoresAlta.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo"> Alta de Proveedor </div>
  <div id="captura" align="center">
    <form method="post" name="Datos" class="FormValidator FormStyles" id="Datos">
      <input name="accion" type="hidden" id="accion" value="alta" />
      <table class="tabla_captura">
        ...
        <tr class="linea_off">
          ...
          <td colspan="3"><input name="num_proveedor" type="text" class="valid Focus toPosInt center" id="num_proveedor" size="5" />
          -
          	<input name="clave_seguridad" type="text" class="valid Focus toPosInt center" id="clave_seguridad" size="3" /></td>
        </tr>
        <tr class="linea_on">
          <th align="left" scope="row">Nombre</th>
          <td colspan="3"><input name="nombre" type="text" class="valid toText toUpper cleanText" id="nombre" size="50" maxlength="100" /></td>
        </tr>
        <tr class="linea_off">
        ...
        <tr class="linea_off">
          ...
          <td colspan="3"><input name="curp" type="text" class="valid Focus toCURP toUpper cleanText" id="curp" size="18" maxlength="18" /></td>
        </tr>
        <tr class="linea_on">
          <th align="left" scope="row">Tipo de persona </th>
          <td colspan="3"><input name="tipopersona" id="tipopersona_t" type="radio" value="TRUE" />
            F&iacute;sica
            <input name="tipopersona" id="tipopersona_f" type="radio" value="FALSE" checked="checked" />
            Moral</td>
        </tr>
        <tr class="linea_off">
        ...
        <tr class="linea_on">
          ...
          <td colspan="3"><input name="email1" type="text" class="valid Focus toEmail" id="email1" size="50" maxlength="50" /></td>
        </tr>
		<tr class="linea_off">
			<th align="left" scope="row">Correo electr&oacute;nico 2</th>
			<td colspan="3"><input name="email2" type="text" class="valid Focus toEmail" id="email2" size="50" maxlength="50" /></td>
		</tr>
		<tr class="linea_on">
			<th align="left" scope="row">Correo electr&oacute;nico 3</th>
			<td colspan="3"><input name="email3" type="text" class="valid Focus toEmail" id="email3" size="50" maxlength="50" /></td>
		</tr>
        <tr class="linea_off">
        ...
        <tr class="linea_off">
        	...
        	<td colspan="3"><input name="facturas_por_mes" type="text" class="valid Focus toPosInt center" id="facturas_por_mes" size="3" /></td>
        	</tr>
        <tr class="linea_on">
        	<th align="left" scope="row">Facturas por pago</th>
        	<td colspan="3"><input name="facturas_por_pago" type="text" class="valid Focus toPosInt center" id="facturas_por_pago" value="10" size="3" /></td>
        	</tr>
        <tr class="linea_off">
        ...
        <tr class="linea_off">
          <th align="left" scope="row">Referencia bancaria para pago</th>
          <td colspan="3"><input name="referencia_bancaria" type="text" class="valid Focus toText" id="referencia_bancaria" size="30" maxlength="10" /></td>
        </tr>
        <tr class="linea_on">
        ...
        <tr class="linea_off">
          ...
          <td colspan="3"><input name="pass_site" type="text" class="valid Focus onlyNumbersAndLetters cleanText" id="pass_site" size="10" maxlength="10" />
