...
<title>Consulta de productos de facturas</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/fac/FacturasProductosConsulta.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Consulta de productos de facturas</div>
