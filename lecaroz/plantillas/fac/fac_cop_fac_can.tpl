...
<tr>
<td align="center" valign="middle"><p class="title">Cancelaci&oacute;n de Facturas Validadas </p>
  <form action="./fac_cop_fac_can.php" method="post" name="form">
	...
	<tr>
      ...
      <td class="tabla"><input name="num_fact[]" type="text" class="insert" id="num_fact" onFocus="tmp.value=this.value;this.select()" onchange="this.value=this.value.replace(/[^a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ]/g,'');this.value=this.value.toUpperCase();" onKeyDown="if (event.keyCode == 13) num_cia[{next}].select()" size="8"></td>
    </tr>
	<!-- END BLOCK : fila -->
  </table>  <p>
...
<td align="center" valign="middle"><!--<p style="font-family: Arial, Helvetica, sans-serif; font-size: 12pt;">Las siguientes facturas no corresponden a la compa&ntilde;&iacute;a capturada </p>-->
  ...
  <p>
    <input type="button" class="boton" value="Siguiente" onClick="document.location='./fac_cop_fac_can.php'">
  </p></td>
</tr>
</table>
<!-- END BLOCK : errores -->
