<table class="table">
	<thead>
		<tr>
			<th colspan="21" align="left" scope="col"><input type="checkbox" id="checkall"> Marcar todos</th>
		</tr>
	</thead>
	<tbody>
		<!-- START BLOCK : pro -->
		<tr>
			<th colspan="21" align="left" class="font15" scope="col">{num_pro} {nombre_pro}{cuentas}</th>
		</tr>
		<tr>
		...
		<!-- START BLOCK : row -->
		<tr id="row{id}">
			<td><input name="id[]" type="checkbox" id="id_{id}" value="{id}" data-pro="{num_pro}" data-tipo="{tipo}"></td>
			<td>{num_fact}</td>
	...
	<tfoot>
		<tr>
			<th colspan="7" align="right">Total general</th>
			<th align="right" class="font12">{importe}</th>
			<th align="right" class="font12">{descuentos}</th>
			<th align="right" class="font12">{iva}</th>
			<th align="right" class="font12">{ieps}</th>
