	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<input name="tipo" type="radio" id="tipo_1" value="1" checked="checked" />
					Agua
					<input name="tipo" type="radio" id="tipo_2" value="2" />
					Predial
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="recurrencia" type="radio" id="recurrencia_1" value="1" checked="checked" />
					Mensual
					<input name="recurrencia" type="radio" id="recurrencia_2" value="2" />
					Bimestral
					<input name="recurrencia" type="radio" id="recurrencia_3" value="3" />
					Anual
				</td>
			</tr>
			<tr>
