<form name="modificar_cia" class="FormValidator" id="modificar_cia">
	<table class="table">
		<thead>
			<tr>
				<th colspan="2">&nbsp;</th>
		...
		<tbody>
			<tr>
				...
				<td>
					<input name="num_cia" type="text" id="num_cia" size="3" value="{num_cia}" readonly="readonly" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="persona_fis_moral" type="radio" id="persona_fis_moral_f" value="FALSE"{persona_fis_moral_f} />
					Moral
					<input name="persona_fis_moral" type="radio" id="persona_fis_moral_t" value="TRUE"{persona_fis_moral_t} />
					F&iacute;sica
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="aplica_iva" type="radio" id="aplica_iva_f" value="FALSE"{aplica_iva_f} />
					No
					<input name="aplica_iva" type="radio" id="aplica_iva_t" value="TRUE"{aplica_iva_t} />
					Si
				</td>
			</tr>
			<tr>
				...
				<td>
					<select name="logo_cfd" id="logo_cfd" class="logo_cfd_select">
						<!-- START BLOCK : logo -->
						<option value="{value}" class="logo_cfd_option" style="background-image: url(imagenes/logos_cfds/{imagen});"{selected}>{text}</option>
						<!-- END BLOCK : logo -->
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input name="med_agua" type="radio" id="med_agua_t" value="TRUE"{med_agua_t} />
					Si
					<input name="med_agua" type="radio" id="med_agua_f" value="FALSE"{med_agua_f} />
					No
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="periodo_pago_luz" type="radio" id="periodo_pago_luz_2" value="2"{periodo_pago_luz_2} />
					Bimestral
					<input name="periodo_pago_luz" type="radio" id="periodo_pago_luz_1" value="1"{periodo_pago_luz_1} />
					Mensual
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="bim_par_imp_luz" type="radio" id="bim_par_imp_luz_1" value="1"{bim_par_imp_luz_1} />
					Impar
					<input name="bim_par_imp_luz" type="radio" id="bim_par_imp_luz_0" value="0"{bim_par_imp_luz_0} />
					Par
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="aviso_saldo" type="radio" id="aviso_saldo_t" value="TRUE"{aviso_saldo_t} />
					Si
					<input name="aviso_saldo" type="radio" id="aviso_saldo_f" value="FALSE"{aviso_saldo_f} />
					No
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="turno_cometra" type="radio" id="turno_cometra_1" value="1"{turno_cometra_1} />
					Matutino
					<input name="turno_cometra" type="radio" id="turno_cometra_2" value="2"{turno_cometra_2} />
					Vespertino
				</td>
			</tr>
			<tr>
