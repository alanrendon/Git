...
<tr>
<td align="center" valign="middle"><p class="title">Alta de Proveedores</p>
  <form action="./fac_pro_altas_v3.php" method="post" name="form">
    ...
    <tr>
      ...
      <td class="vtabla"><input name="num_proveedor" type="text" class="nombre" id="num_proveedor" onfocus="tmp.value=this.value;this.select()" onchange="isInt(this,tmp)" onkeyup="movCursor(event.keyCode,clave_seguridad,null,clave_seguridad,null,rfc)" value="{num_pro}" size="4" readonly="true" /></td>
    ...
    <tr>
      ...
      <td colspan="3" class="vtabla"><input name="tipopersona" type="radio" value="TRUE" />
        F&iacute;sica
    ...
    <tr>
      ...
      <td colspan="3" class="vtabla"><input name="prioridad" type="radio" value="TRUE" checked="checked" />
        Alta
          <input name="prioridad" type="radio" value="FALSE" />
          Baja</td>
      <th class="vtabla">Resta compras </th>
      <td class="vtabla"><input name="restacompras" type="radio" value="TRUE" />
        Si
          <input name="restacompras" type="radio" value="FALSE" checked="checked" />
          No</td>
    </tr>
    <tr>
      <th class="vtabla">Validar facturas </th>
      <td colspan="3" class="vtabla"><input name="verfac" type="radio" value="TRUE" checked="checked" />
        Si
          <input name="verfac" type="radio" value="FALSE" />
          No</td>
      <th class="vtabla">Tipo de documentaci&oacute;n </th>
      <td class="vtabla"><input name="tipo_doc" type="radio" value="2" checked="checked" />
        Factura
    ...
    <tr>
      ...
      <td colspan="3" class="vtabla"><input name="idtipopago" type="radio" value="1" checked="checked" />
        Cr&eacute;dito
          <input name="idtipopago" type="radio" value="2" />
          Contado</td>
      <th class="vtabla">Tipo de pago </th>
      <td class="vtabla"><input name="trans" type="radio" value="FALSE" checked="checked" />
        Cheque
    ...
    <tr>
      ...
      <td colspan="3" class="vtabla"><select name="idbanco" class="insert" id="idbanco">
		...
		<!-- START BLOCK : banco -->
		<option value="{idbanco}">[{num}][{clave}] {nombre}</option>
		<!-- END BLOCK : banco -->
      </select>      </td>
      <th class="vtabla">Leyendas</th>
      <td class="vtabla"><input name="para_abono" type="checkbox" id="para_abono" value="TRUE" checked="checked" />
    ...
    <tr>
      ...
      <td colspan="5" class="vtabla"><textarea name="observaciones" rows="4" class="insert" id="observaciones" style="width:100%;"></textarea></td>
      </tr>
    <!-- START BLOCK : zap -->
	<tr>
      <td colspan="6" class="vtabla">&nbsp;</td>
...
function validarClave() {
	if (f.clave_seguridad.value == '' || f.clave_seguridad.value == '0') {
		...
		// Pedir datos
		myConn.connect('./fac_pro_altas_v3.php', 'GET', 'cs=' + get_val(f.clave_seguridad), resultClave);
	}
}
...
function cambiaCodDesc(i) {
	if (document.getElementById('cod_desc' + i).value == '' || document.getElementById('cod_desc' + i).value == '0') {
		...
		// Pedir datos
		myConn.connect('./fac_pro_altas_v3.php', 'GET', 'cod=' + get_val(document.getElementById('cod_desc' + i)) + '&i=' + i, resultCod);
	}
}
...
window.onload = f.clave_seguridad.select();
//-->
</script>
<!-- END IGNORE -->
</body>
