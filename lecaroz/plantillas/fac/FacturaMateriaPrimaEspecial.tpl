...
<title>Factura de Materia Prima Especial</title>
...
<script type="text/javascript" src="jscripts/fac/FacturaMateriaPrimaEspecial.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Factura de Materia Prima Especial</div>
