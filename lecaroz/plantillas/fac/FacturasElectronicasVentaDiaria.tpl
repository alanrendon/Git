...
<title>Facturas Electr&oacute;nicas de Venta Diaria</title>
...
<script type="text/javascript" src="jscripts/fac/FacturasElectronicasVentaDiaria.js"></script>
<script language="JavaScript" type="text/javascript" src="menus/stm31.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Facturas Electr&oacute;nicas de Venta Diaria </div>
