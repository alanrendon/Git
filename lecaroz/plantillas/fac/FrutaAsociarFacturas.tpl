...
<script type="text/javascript" src="jscripts/fac/FrutaAsociarFacturas.js"></script>
</head>

<body>
<div id="contenedor">
	<div id="titulo">Asociar remisiones de fruta con facturas</div>
			...
			<table class="tabla_captura">
				...
				<tbody id="tbody">
					<tr class="linea_off">
						...
						<td align="center"><input name="total[]" type="text" disabled="disabled" class="right" id="total" size="10" /></td>
						<td align="center"><input name="num_fact[]" type="text" class="valid Focus onlyNumbersAndLetters toUpper" id="num_fact" size="10" /></td>
				</tr>
				</tbody>
			</table>
			<p>
