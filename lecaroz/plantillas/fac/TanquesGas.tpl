...
<script type="text/javascript" src="/lecaroz/jscripts/fac/TanquesGas.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Tanques de gas</div><div id="captura" align="center"></div>
</div>
