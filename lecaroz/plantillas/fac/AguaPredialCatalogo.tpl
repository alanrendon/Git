...
<title>Cat&aacute;logo de medidores de agua y prediales</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/fac/AguaPredialCatalogo.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Cat&aacute;logo de medidores de agua y prediales</div><div id="captura" align="center"></div>
</div>
