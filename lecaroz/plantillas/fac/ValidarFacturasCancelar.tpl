...
<title>Cancelar facturas validadas</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/fac/ValidarFacturasCancelar.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Cancelar facturas validadas</div>
	<div id="captura" align="center">
		<form name="datos_form" class="FormValidator" id="datos_form">
			<table class="table">
				<thead>
					<tr>
			...
			<p>
				<input name="cancelar" type="button" id="cancelar" value="Cancelar validaciones" />
			</p>
		</form>
	</div>
</div>
