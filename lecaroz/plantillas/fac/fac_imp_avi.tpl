...
<tr>
<td align="center" valign="middle"><p class="title">Impresi&oacute;n de Aviso de Atraso de Alta/Baja del IMSS</p>
  <form action="./fac_imp_avi.php" method="get" name="form"><table class="tabla">
    <tr>
      <th class="vtabla" scope="row">Altas pendientes </th>
      <td class="vtabla"><input name="tipo" type="radio" value="alta" checked></td>
    </tr>
    <tr>
      <th class="vtabla" scope="row">Bajas pendientes </th>
