...
<p id="accion">Se adjunta XML de carga para su validaci&oacute;n</p>
<hr />
<p id="footer">Favor de no responder a este correo electr&oacute;nico, este buz&oacute;n no se supervisa y no recibira respuesta. Si necesita informaci&oacute;n adicional escriba al correo <a href="mailto:sistemas@lecaroz.com">sistemas@lecaroz.com</a> y con gusto le atenderemos.</p>
</body>
<!-- THE CAKE IS A LIE -->
</html>
