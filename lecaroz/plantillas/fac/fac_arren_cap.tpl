...
<p class="title">FACTURAS DE ARRENDADORA </p>
<form name="form" method="post" action="./insert_fac_arren.php?tabla={tabla}">
...
<table class="tabla">
	  ...
	  <tr>
	    <th class="vtabla">Número de proveedor</th>
	    <td class="vtabla"><input name="num_proveedor" type="text" class="insert" id="num_proveedor" value="733" size="4"></td>
	    </tr>
