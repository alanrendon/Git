...
<script type="text/javascript" src="jscripts/fac/ReciboFiniquito.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Recibo Finiquito </div>
  <div id="captura" align="center">
    <form name="Datos" class="FormValidator FormStyles" id="Datos">
      ...
      <br />
      <p>
        <input name="generar" type="button" class="boton" id="generar" value="Generar Recibo" />
      </p>
    </form>
  </div>
</div>
