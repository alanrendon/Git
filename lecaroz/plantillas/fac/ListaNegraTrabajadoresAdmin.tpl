...
<title>Administrar lista negra de trabajadores</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/fac/ListaNegraTrabajadoresAdmin.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Administrar lista negra de trabajadores</div>
