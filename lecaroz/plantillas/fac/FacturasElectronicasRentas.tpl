...
<title>Facturas Electr&oacute;nicas para Rentas</title>
...
<script type="text/javascript" src="jscripts/fac/FacturasElectronicasRentas.js"></script>
...
<body>
<div id="contenedor">
  <div id="titulo">Facturas Electr&oacute;nicas para Rentas </div>
