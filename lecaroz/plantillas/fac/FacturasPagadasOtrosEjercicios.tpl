...
<title>Consulta de facturas pagadas en otros ejercicios</title>
...
<script type="text/javascript" src="/lecaroz/jscripts/fac/FacturasPagadasOtrosEjercicios.js"></script>
<style type="text/css">
.icono {
	opacity: 0.6;
}
...
<body>
<div id="contenedor">
	<div id="titulo">Consulta de facturas pagadas en otros ejercicios</div>
