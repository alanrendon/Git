...
{
	new Request({
		url: 'FacturasZapateriasConsultaV2.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
...
{
	boxViewCFD.setContent('<iframe frameborder="0" width="800" height="400" src="FacturasZapateriasConsultaV2.php?accion=visualizar_cfd&id=' + id + '"></iframe>').open();
}
...
// 	var url = 'FacturasZapateriasConsultaV2.php',
