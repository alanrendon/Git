window.addEvent('domready', function()
{
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'ReporteTotalesConceptoBancario.php?accion=reporte&' + param);
		},
...
var inicio = function ()
{
	new Request(
	{
		url: 'ReporteTotalesConceptoBancario.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
		...
		onSuccess: function(result)
		{
			...
			document.id('banco').addEvent('change', obtener_codigos).fireEvent('change');
...
{
	var url = 'ReporteTotalesConceptoBancario.php',
