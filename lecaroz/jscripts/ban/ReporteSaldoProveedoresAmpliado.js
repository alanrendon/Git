window.addEvent('domready', function()
{
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'ReporteSaldoProveedoresAmpliado.php?accion=reporte&' + param);
		},
...
var inicio = function()
{
	new Request(
	{
		url: 'ReporteSaldoProveedoresAmpliado.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
...
{
	var url = 'ReporteSaldoProveedoresAmpliado.php',
