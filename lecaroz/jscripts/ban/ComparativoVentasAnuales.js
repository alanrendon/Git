window.addEvent('domready', function()
{
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'ComparativoVentasAnuales.php?accion=reporte&' + param);
		},
...
var inicio = function()
{
	new Request(
	{
		url: 'ComparativoVentasAnuales.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
...
var consultar = function()
{
	...
	else
	{
		...
		{
			alert('Debe especificar la fecha de referencia');
...
{
	var url = 'ComparativoVentasAnuales.php',
