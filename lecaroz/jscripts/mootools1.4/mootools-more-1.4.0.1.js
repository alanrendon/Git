...
// Load this file's selection again by visiting: http://mootools.net/more/e5162353babe44d7b7ead5886915fb2e 
// Or build this file again with packager using: packager build More/More More/Array.Extras More/Date More/Date.Extras More/Number.Format More/Object.Extras More/String.Extras More/String.QueryString More/URI More/URI.Relative More/Hash More/Element.Forms More/Element.Measure More/Element.Position More/Drag More/Drag.Move More/Slider More/Sortables More/Scroller More/Tips More/Locale More/Locale.en-US.Date More/Locale.en-US.Number
/*
---
copyrights:
...
},toQueryString:function(b){return Object.toQueryString(this,b);}});a.alias({indexOf:"keyOf",contains:"hasValue"});})();Element.implement({tidy:function(){this.set("value",this.get("value").tidy());
