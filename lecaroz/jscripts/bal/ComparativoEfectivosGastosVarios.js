window.addEvent('domready', function()
{
	...
	{
		id: 'box_processing',
		content: '<img src="/lecaroz/imagenes/mbox/mBox-Spinner.gif" width="32" height="32" /> Procesando, recabar los datos puede durar hasta 10 minutos...',
		overlay: true,
		overlayStyles: {
			color: 'white',
			opacity: 0.8
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'ComparativoEfectivosGastosVarios.php?accion=reporte&' + param);
		},
...
var inicio = function ()
{
	new Request(
	{
		url: 'ComparativoEfectivosGastosVarios.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
...
var exportar = function() {
	var url = 'ComparativoEfectivosGastosVarios.php',
