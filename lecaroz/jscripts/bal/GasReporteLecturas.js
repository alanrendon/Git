window.addEvent('domready', function()
{
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'GasReporteLecturas.php?accion=reporte&' + param);
		},
...
var inicio = function ()
{
	new Request(
	{
		...
		onSuccess: function(result)
		{
			...
			document.id('consultar_desglosado').addEvent('click', consultar_desglosado);
...
var consultar_desglosado = function()
{
...
var exportar = function() {
	var url = 'GasReporteLecturas.php',
