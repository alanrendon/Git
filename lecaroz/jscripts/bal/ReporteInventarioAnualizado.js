window.addEvent('domready', function()
{
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'ReporteInventarioAnualizado.php?accion=reporte&' + param);
		},
...
var inicio = function ()
{
	new Request(
	{
		url: 'ReporteInventarioAnualizado.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
...
var exportar = function() {
	var url = 'ReporteInventarioAnualizado.php',
