window.addEvent('domready', function()
{
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'ReporteVentasGastosRosticerias.php?accion=reporte&' + param);
		},
...
var inicio = function()
{
	new Request(
	{
		url: 'ReporteVentasGastosRosticerias.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
...
{
	var url = 'ReporteVentasGastosRosticerias.php',
