window.addEvent('domready', function()
{
	...
	boxReporte = new mBox.Modal(
	{
		...
		{
			document.id('reporte_frame').set('src', 'RosticeriasFacturasConsulta.php?accion=reporte&' + param);
		},
...
{
	new Request({
		url: 'RosticeriasFacturasConsulta.php',
		data: 'accion=inicio',
		onRequest: function()
		{
			boxProcessing.open();
...
{
	var url = 'RosticeriasFacturasConsulta.php',
