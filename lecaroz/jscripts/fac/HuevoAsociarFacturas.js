...
var ObtenerRemision = function() {
	...
	if ($$('input[id=num_rem]')[i].get('value') != '') {
		...
		$$('input[id=cajas]')[i].set('value', '');
		$$('input[id=peso_neto]')[i].set('value', '');
...
var DesglosarDatos = function() {
	...
	$$('input[id=cajas]')[i].set('value', data.cajas.numberFormat(0, '', ','));
	$$('input[id=peso_neto]')[i].set('value', data.peso_neto.numberFormat(2, '.', ','));
	$$('input[id=precio]')[i].set('value', data.precio.numberFormat(2, '.', ','));
...
var ValidarFactura = function() {
	...
	if ($$('input[id=num_pro]')[i].get('value') != '' && $$('input[id=num_fact]')[i].get('value') != '') {
		var data = $$('input[id=num_pro]')[i].get('value');
