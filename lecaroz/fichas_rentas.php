...
//echo $i;
	...
	$_fecha_1=explode("/",$recibos[$i]['fecha_pago']);
	...
	$tpl->assign("fecha",$_fecha_1[0]." DE ".strtoupper(mes_escrito($_fecha_1[1])));
	$tpl->assign("anio",$_fecha_1[2]);
