<?php
// ALTA DE CONTADORES
// Tabla 'catalogo_contadores'
// Menu 'Bancos->Catalogos'

define ('IDSCREEN',6611); // ID de pantalla
...
$descripcion_error[1] = "C&oacute;digo de contador ya existe en la Base de Datos";
...
$id = nextid($screen->tabla, "idcontador", $dsn);
$tpl->assign("id",$id);
