	...
	switch ($_REQUEST['accion']) {
		case 'reporte':
			...
			*/
			...
			if ($result) {
				$tpl = new TemplatePower('plantillas/bal/GraficacionDatosBalanceReporte.tpl');
				$tpl->prepare();
				...
				$campos = array(
					...
					'mat_prima_utilizada' => 'Materia Prima Utilizada',
					'mano_obra' => 'Mano de Obra',
					'panaderos' => 'Panaderos',
					'gastos_fab' => 'Gastos de Fabricaci&oacute;n',
					'costo_produccion' => 'Costo de Producci&oacute;n',
					'utilidad_bruta' => 'Utilidad Bruta',
					'pan_comprado' => 'Pan Comprado',
					'gastos_generales' => 'Gastos Generales',
					'gastos_caja' => 'Gastos de Caja',
					'reserva_aguinaldos' => 'Reserva para Aguinaldos',
					'gastos_otras_cias' => 'Gastos pagados por otras compa&ntilde;&iacute;as',
				...
				foreach ($result as $rec) {
					...
					$tpl->assign('url', 'GraficacionDatosBalance.php?accion=grafico&arg=' . urlencode(json_encode($argumentos)));
				}
...
$tpl = new TemplatePower('plantillas/bal/GraficacionDatosBalance.tpl');
$tpl->prepare();
