...
if (isset($_REQUEST['accion'])) {
	switch ($_REQUEST['accion']) {
		...
		case 'inicio':
			...
			$tpl = new TemplatePower('plantillas/ban/CatalogoAdministradoresInicio.tpl');
			$tpl->prepare();
		...
		case 'alta':
			$tpl = new TemplatePower('plantillas/ban/CatalogoAdministradoresAlta.tpl');
			$tpl->prepare();
...
$tpl = new TemplatePower('plantillas/ban/CatalogoAdministradores.tpl');
$tpl->prepare();
