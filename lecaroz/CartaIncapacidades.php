...
if (isset($_REQUEST['accion'])) {
	switch ($_REQUEST['accion']) {
		...
		case 'recibo':
			...
			$tpl = new TemplatePower('plantillas/fac/CartaIncapacidadesDocumento.tpl');
			$tpl->prepare();
			...
			$tpl->assign('concepto', $_REQUEST['concepto']);
...
$tpl = new TemplatePower('plantillas/fac/CartaIncapacidades.tpl');
$tpl->prepare();
