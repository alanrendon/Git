...
$tpl->assignInclude("body","./plantillas/pan/pan_pastel_minimod.tpl");
$tpl->prepare();
$venta=0;
$dif_otros=0;
$dif_venta=0;
		...
		if(!($fac[0]['idexpendio'] > 0)){
			...
			else if($fac[0]['base'] < $_POST['base'])
			{
				...
				if($_POST['resta_pagar'] > 0){
					...
					$sql="UPDATE mov_expendios SET rezago=rezago - ".$dif_venta." WHERE num_cia=".$fac[0]['num_cia']." AND fecha >='".$_POST['fecha']."' AND num_expendio=".$fac[0]['idexpendio'];
					ejecutar_script($sql,$dsn);
