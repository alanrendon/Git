...
if (isset($_REQUEST['accion'])) {
	switch ($_REQUEST['accion']) {
		...
		case 'recibo':
			...
			$tpl = new TemplatePower('plantillas/fac/ReciboFiniquitoDocumento.tpl');
			$tpl->prepare();
			...
			$tpl->assign('sueldo', $_REQUEST['sueldo']);
			$tpl->assign('neto', $_REQUEST['neto']);
...
$tpl = new TemplatePower('plantillas/fac/ReciboFiniquito.tpl');
$tpl->prepare();
