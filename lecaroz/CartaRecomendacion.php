...
if (isset($_REQUEST['accion'])) {
	switch ($_REQUEST['accion']) {
		...
		case 'carta':
			...
			$tpl = new TemplatePower('plantillas/fac/CartaRecomendacionDocumento' . (isset($_REQUEST['fecha_inicio']) && isset($_REQUEST['fecha_termino']) ? 2 : 1) . '.tpl');
			$tpl->prepare();
			...
			if (isset($_REQUEST['fecha_inicio']) && isset($_REQUEST['fecha_termino'])) {
				$tpl->assign('fecha_inicio', $_REQUEST['fecha_inicio']);
				$tpl->assign('fecha_termino', $_REQUEST['fecha_termino']);
			}
...
$tpl = new TemplatePower('plantillas/fac/CartaRecomendacion.tpl');
$tpl->prepare();
