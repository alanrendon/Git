...
$tpl->assignInclude("body","./plantillas/fac/fac_pue_mod.tpl");
$tpl->prepare();
...
$tpl->assign("tabla","catalogo_puestos");
...
if($_POST['cont'] >0)
{
	for($i=0;$i<$_POST['cont'];$i++)
	{
		if($_POST['modificar'.$i]==1)
		{
			...
			$var++;
			$tpl->assign('cod_puestos',$_POST['cod_puestos'.$i]);
			$tpl->assign('descripcion',$_POST['descripcion'.$i]);
			$tpl->assign("sueldo",$_POST['sueldo'.$i]);
		}
	}
