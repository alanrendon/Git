...
$tpl->assignInclude("body","./plantillas/ban/ban_conta_mod.tpl");
$tpl->prepare();
...
$tpl->assign("tabla","catalogo_contadores");
...
if($_POST['cont'] >0)
{
	for($i=0;$i<$_POST['cont'];$i++)
	{
		if($_POST['modificar'.$i]==1)
		{
			...
			$tpl->assign("i",$var);
			$var++;
			$tpl->assign('idcontador',$_POST['idcontador'.$i]);
			$cia = obtener_registro("catalogo_contadores",array("idcontador"),array($_POST['idcontador'.$i]),"","",$dsn);
