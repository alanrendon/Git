...
$tpl->assignInclude("body","./plantillas/fac/fac_ifm_con.tpl");
$tpl->prepare();
...
if($_GET['tipo_con']==0)
	$sql="select num_cia, codmp, existencia, unidadconsumo, catalogo_mat_primas.nombre from inventario_real join catalogo_mat_primas using(codmp) where num_cia='".$_GET['num_cia']."' order by catalogo_mat_primas.tipo, catalogo_mat_primas.nombre";
else
	$sql="select num_cia, codmp, existencia, unidadconsumo, catalogo_mat_primas.nombre from inventario_real join catalogo_mat_primas using(codmp) where num_cia between 1 and 100 order by inventario_real.num_cia, catalogo_mat_primas.tipo, catalogo_mat_primas.nombre";
