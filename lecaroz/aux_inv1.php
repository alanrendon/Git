...
$tpl->assignInclude("body","./plantillas/pan/aux_inv1.tpl");
$tpl->prepare();
...
$fecha_historico = date("d/m/Y",mktime(0,0,0,$_GET['mes'],0,date("Y")));
$fecha1 = date("d/m/Y",mktime(0,0,0,$_GET['mes'],1,date("Y")));
$fecha2 = date("d/m/Y",mktime(0,0,0,$_GET['mes']+1,0,date("Y")));
