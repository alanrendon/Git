...
$tpl->assignInclude("body","./plantillas/ban/ban_auditor_mod.tpl");
$tpl->prepare();
...
if($_POST['cont'] >0)
{
	for($i=0;$i<$_POST['cont'];$i++)
	{
		if($_POST['modificar'.$i]==1)
		{
			...
			$tpl->assign("i",$var);
			$var++;
			$tpl->assign('idauditor',$_POST['idauditor'.$i]);
			$cia = obtener_registro("catalogo_auditores",array("idauditor"),array($_POST['idauditor'.$i]),"","",$dsn);
