...
if(count($files) || count($folder))
{
   for($i = 0; $i < count($files); $i++)
   {
      ...
      $files_options .= '<tr'.$bgColor.'>
                           ...
                           <td align="left"><label for="files'.$i.'">'.$files[$i].'</label></td>
...
$list_op_adm .= '<font color="#FFFF66">'.strtoupper($CONFIG_USERS_ADMIN[$user_id]).'</font> |
...
<div id="header_menu"><?php echo $list_op_adm;?></div>
<table width="98%" align="center">
  <tr>
    <td><?php echo $phpSM;?></td>
  </tr>
</table>
<div class="creditos" align="center">
  Copyright &copy; phpSiteManager.<br />
  Creado por Yoilier Oro Castell&oacute;.<br />
  Todos los derechos reservados.
</div>
</body>
</html>