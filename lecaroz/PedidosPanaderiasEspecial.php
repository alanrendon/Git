...
if (isset($_REQUEST['accion'])) {
	switch ($_REQUEST['accion']) {
		case 'inicio':
			$tpl = new TemplatePower('plantillas/ped/PedidosPanaderiasEspecialInicio.tpl');
			$tpl->prepare();
		...
		case 'consultar':
			...
			if ($result) {
				...
				$tpl = new TemplatePower('plantillas/ped/PedidosPanaderiasEspecialResultado.tpl');
				$tpl->prepare();
		...
		case 'realizarPedido':
			...
			$tpl = new TemplatePower('plantillas/ped/PedidosPanaderiasEspecialFin.tpl');
			$tpl->prepare();
...
$tpl = new TemplatePower('plantillas/ped/PedidosPanaderiasEspecial.tpl');
$tpl->prepare();
