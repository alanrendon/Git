...
/**
 *      \file       root/factorytools_script.php
 *		\ingroup    root
...
// Examples for manipulating class factorytools_class
require_once(DOL_DOCUMENT_ROOT."/../root/factorytools.class.php");
$myobject=new Factorytools($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."factorytools";
