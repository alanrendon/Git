...
class box_factory extends ModeleBoxes {
	...
	function loadBox($max=5)
	{
		...
		include_once(DOL_DOCUMENT_ROOT."/factory/class/factory.class.php");
		...
		if ($user->rights->factory->lire)
		{
			...
			if ($result)
			{
				...
				while ($i < $num)
				{
					//$this->info_box_contents[$i][0] = array('td' => 'align="left" width="16"','logo' => 'factory@factory');
					...
					$this->info_box_contents[$i][0] = array('td' => 'align="left"',
						...
						'url' => DOL_URL_ROOT."/factory/fiche.php?id=".$objp->rowid);
					$this->info_box_contents[$i][1] = array('td' => 'align="left"',
						'text' => $product_static->getNomUrl(1),
						'logo' => 'product',
						'url' => DOL_URL_ROOT."/product/fiche.php?id=".$objp->fk_product);
					$this->info_box_contents[$i][2] = array('td' => 'align="left"',
						'text' => $entrepot_static->getNomUrl(1),
						'logo' => 'stock',
						'url' => DOL_URL_ROOT."/product/stock/fiche.php?id=".$objp->fk_entrepot);
					...
					$this->info_box_contents[$i][3] = array('td' => 'align="left"', 'text' => $langs->trans("StartFactory").$datestart);
					$this->info_box_contents[$i][4] = array('td' => 'align="left"', 'text' => $langs->trans("EndFactory").$dateend);
						

					$this->info_box_contents[$i][5] = array('td' => 'align="right" ', 'text' => $factory_static->LibStatut($objp->fk_statut, 3));
