...
class mod_babouin extends ModeleNumRefFactory
{
	...
	function info()
	{
		...
		$tooltip=$langs->trans("GenericMaskCodes",$langs->transnoentities("FactoryCard"),$langs->transnoentities("FactoryCard"));
		$tooltip.=$langs->trans("GenericMaskCodes2");
		$tooltip.=$langs->trans("GenericMaskCodes3");
		$tooltip.=$langs->trans("GenericMaskCodes4a",$langs->transnoentities("FactoryCard"),$langs->transnoentities("FactoryCard"));
		$tooltip.=$langs->trans("GenericMaskCodes5");

		// Parametrage du prefix
		$texte.= '<tr><td>'.$langs->trans("Mask").':</td>';
		$texte.= '<td align="right">'.$form->textwithpicto('<input type="text" class="flat" size="24" name="maskvalue" value="'.$conf->global->FACTORY_BABOUIN_MASK.'">',$tooltip,1,1).'</td>';
