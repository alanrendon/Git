...
if ($result)
{
	...
	print_liste_field_titre($langs->trans("Entrepot"),$_SERVER["PHP_SELF"],"p.firstname", $begin, $param, '', $sortfield,$sortorder);
	...
	print '</td>';
	print '<td class="liste_titre">';
	select_entrepot(GETPOST("entrepotid"),"entrepotid",1,1);
	print '</td>';
