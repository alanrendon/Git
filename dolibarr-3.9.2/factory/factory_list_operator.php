...
llxHeader("","",$langs->trans("PropalFactoryList".$product->type));
dol_htmloutput_mesg($mesg);
print_fiche_titre($langs->trans("PropalFactoryList"));
...
print '<br/><a class="button" href="factoryoperator_card.php?action=create">Nuevo operador</a>';
print '<a class="button" href="factoryoperator_card.php">Asignar herramienta</a>';
...
if ($result)
{
	...
	print_liste_field_titre($langs->trans('QtyNeedOF'),$_SERVER["PHP_SELF"],'qty','',$param,'align="center"',$sortfield,$sortorder);	
	print_liste_field_titre($langs->trans('QtyPen'),$_SERVER["PHP_SELF"],'','',$param,'align="center"',$sortfield,$sortorder);	
	...
	while ($i < min($num,$limit))
	{
		...
		print '<tr '.$bc[$var].'>';	
			...
			print '<td align="center">';
				print $fact->get_qty_propal($objp->propalid);
			print "</td>\n";

			print '<td align="center">';
				print $fact->get_qty_propal_pen($objp->propalid);
			print "</td>\n";
			print '<td align="center">';
			...
			if(is_null($objp->fk_status_factory) || strcmp($objp->fk_status_factory, '')==0){			 
