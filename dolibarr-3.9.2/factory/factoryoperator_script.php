...
/**
 *      \file       root/factoryoperator_script.php
 *		\ingroup    root
...
// Examples for manipulating class factoryoperator_class
require_once(DOL_DOCUMENT_ROOT."/../root/factoryoperator.class.php");
$myobject=new Factoryoperator($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."factoryoperator";
