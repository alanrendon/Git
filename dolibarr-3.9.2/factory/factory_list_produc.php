...
if ($result)
{
	...
	print_liste_field_titre($langs->trans('QtyNeedOF'),$_SERVER["PHP_SELF"],'qty','',$param,'align="right"',$sortfield,$sortorder);	
	...
	while ($i < min($num,$limit))
	{
		...
		print '<tr '.$bc[$var].'>';	
			...
			print '<td align="right">';
				$num2= $fact->get_qty_propal($objp->propalid);
				print number_format($num2,0,'.',',');
			print "</td>\n";
