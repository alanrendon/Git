<?php
    ...
    foreach($apartados_gastos as $gastos){
     ...
     $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('j5', 'Total Gastos' )
                ->setCellValue('j6', 'Total Costos' )
                ->setCellValue('j6', 'Utilidad Bruta' )
                ->setCellValue('j6', 'Utilidad Operativa' )
                ->setCellValue('k4', number_format($totalVentas,2,'.',',') )
                ->setCellValue('k5', number_format($totalGastos,2,'.',',') )
                ->setCellValue('k6', number_format($totalCostos,2,'.',',') )
