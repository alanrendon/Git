...
<html lang="es">
    ...
    <div class="right_col" role="main">
        <div class="x_title">
            <h2>Gastos pendientes de contabilizar</h2>
            ...
            <div id="dv_tabla">
                <form id="frm_AsignarPoliza" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <table class="table table-striped jambo_table bulk_action" id="datatable">
                        ...
                        <tbody>
                            <?php
                            //print "<pre>";print_r($gts);print "</pre>";
                            foreach ($gts as $tr) {
                                $statut = $tr['fk_statut'];
                                if ($statut == 0) {
                                    $statut = 'Borrador';
                                ...
                                <tr>
                                    <td><?= $tr['ref'] ?></td>
                                    <td><?= "De " . $tr['date_debut'] . " a " . $tr['date_fin'] ?></td>
                                    <td><?= $statut ?></td>
                                    <td><?= $tr['date_approve'] ?></td>
                                    <td align="right"><?= $moneda . "" . number_format($tr['total_ht'], 2) ?></td>
                                    <td align="right"><?= $moneda . "" . number_format($tr['total_tva'], 2) ?></td>
                                    <td align="right"><?= $moneda . "" . number_format($tr['total_ttc'], 2) ?></td>
                                    <td><input name='transid[]' type='checkbox' value='<?php echo $tr['idgasto'] ?>'></td>
                                </tr>
                                <?php
                            }
                            ?>
...
function getFacturaInfo() {
    ...
    $("#dv_datos").toggle('fast');
    $.ajax({
        url: "../get/get_gastos_pendientes.php",
        type: 'POST',
