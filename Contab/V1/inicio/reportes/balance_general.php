...
$operativa = get_estado_resultados($periodo);
			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <form method="POST" id="frm_periodo" action="balance_general.php">
                                   <fieldset>
                            ...
                            <div class="col-md-4 text-right">
                               <!--  <a href="../get/get_balance_general_excel.php?inicio=<?php// echo $periodo[0].'&fin='.$periodo[1]; ?>" class="btn btn-default buttons-csv buttons-html5 btn-sm" tabindex="0" aria-controls="datatable-buttons" target="_blank">
                                ...
                                <div class="x_title">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link" title="Minimizar"><i class="fa fa-chevron-up" style="color: black"></i></a></li>
                                            ...
                                            <li><a class="download-link" title="XLS"  href="../get/get_balance_general_excel.php?inicio=<?php echo $periodo[0].'&fin='.$periodo[1]; ?>" target="_blank"> <i class="fa fa-file-excel-o " style="color: black"></i></a></li>
						...
						<div class="x_content">
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12">
								  <?php $total=0; foreach($apartados_activo as $activo): ?>
                                        <?php $cont++; ?>
                                         <?php $datos= $balance->get_balance($activo->rowid,$estado); ?>
                                           <?php if(count($datos)>0): ?>
                                             <div class="x_panel">
                                                <div class="x_title">
                                                    <h2><i class="fa fa-bars"></i> <?php echo $activo->apartado; ?></h2>
                                                    <ul class="nav navbar-right panel_toolbox">
                                                        ...
                                                        <table width="100%">
                                                           ...
                                                           <?php endforeach ?>
                                                            ...
                                                            <tr>
                                                                <td></td>
                                                                <td></td>
                                                                 <td style="text-align: right !important;"><?php echo $moneda.' '.number_format($total,2); $totalActivo+=$total; ?></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                           ...
                                           <?php endif?>
                                           <?php if($cont==count($apartados_activo)): ?>
                                                <div class="x_panel">
                                                    <div class="x_title">
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td style="text-align: right !important;"><?php echo $moneda.' '.number_format($totalActivo,2); ?></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
								...
								<div class="col-md-6 col-sm-12 col-xs-12">
							       <?php $total=0; foreach($apartados_pasivos as $pasivo): ?>
                                        <?php $cont++;?>
                                         <?php $datos= $balance->get_balance($pasivo->rowid,$estado); ?>
                                           <?php if(count($datos)>0): ?>
                                             <div class="x_panel">
                                                <div class="x_title">
                                                    <h2><i class="fa fa-bars"></i> <?php echo $pasivo->apartado; ?></h2>
                                                    <ul class="nav navbar-right panel_toolbox">
                                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                                    </ul>
                                                    <div class="clearfix"></div>
                                                        ...
                                                        <table width="100%">
                                                           ...
                                                           <?php endforeach ?>
                                                            ...
                                                            <tr>
                                                                <td></td>
                                                                <td></td>
                                                                 <td style="text-align: right !important;"><?php echo $moneda.' '.number_format($total,2); $totalPasivo+=$total; ?></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                           ...
                                           <?php endif?>
                                           <?php if($cont==count($apartados_pasivos)): ?>
                                              
                                               <?php $total=0; foreach($apartados_capital as $capital): ?>
        
                                                 <?php $datos= $balance->get_balance($capital->rowid,$estado); ?>
                                                   <?php if(count($datos)>0): ?>
                                                     <div class="x_panel">
                                                        <div class="x_title">
                                                            <h2><i class="fa fa-bars"></i> <?php echo $capital->apartado; ?></h2>
                                                            <ul class="nav navbar-right panel_toolbox">
                                                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                                            </ul>
                                                            <div class="clearfix"></div>
                                                                ...
                                                                <table width="100%">
                                                                   ...
                                                                   <?php endforeach ?>
                                                                    ...
                                                                    <tr>
                                                                        <td></td>
                                                                        <td></td>
                                                                         <td style="text-align: right !important;"><?php echo $moneda.' '.number_format($total,2); $totalCapital+=$total; ?></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="x_title">
                                                        <table width="100%">
                                                           <tr>
															...
															<td></td>
															<td style="text-align: right !important;"><?php echo $moneda.' '.number_format($totalPasivo,2); ?></td>
														</tr>
														<tr>
															<td><strong>Capital Contable</strong></td>
															<td></td>
															<td style="text-align: right !important;"><?php echo $moneda.' '.number_format($totalCapital,2) ?></td>
														</tr>
														<tr>
															<td><strong>Total Pasivo + Capital Contable</strong></td>
															<td></td>
															<td style="text-align: right !important;"><?php echo $moneda.' '.number_format(($totalPasivo+$totalCapital),2) ?></td>
														</tr>
                                                       <tr>
															<td><strong>Utilidad Operativa</strong></td>
															<td></td>
															<td style="text-align: right !important;"><?php echo $moneda.' '.number_format($operativa,2) ?></td>
														</tr>
                                                        </table>
                                                    </div>
                                                    <div class="x_content">
                                                        <table width="100%">
                                                           ...
                                                           <tr>
                                                                ...
                                                                <td></td>
                                                                <td style="text-align: right !important;"><?php echo $moneda.' '.number_format(($totalPasivo+$totalCapital)+$operativa,2) ?></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
