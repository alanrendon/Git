						...
						<div class="x_title">
						 ...
						 <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                               <!--  <a href="../get/balance_comprobacion_excel.php?inicio=<?//=$periodo[0].'&fin='.$periodo[1]; ?>" class="btn btn-default buttons-csv buttons-html5 btn-sm" tabindex="0" aria-controls="datatable-buttons" target="_blank">
                                ...
                                <div class="x_title">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link" title="Minimizar"><i class="fa fa-chevron-up" style="color: black"></i></a></li>
                                            ...
                                            <li><a class="download-link" title="XLS" href="../get/balance_comprobacion_excel.php?inicio=<?=$periodo[0].'&fin='.$periodo[1]; ?>" target="_blank"> <i class="fa fa-file-excel-o " style="color: black"></i></a></li>
