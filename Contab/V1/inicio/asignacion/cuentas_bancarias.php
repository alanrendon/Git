			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<div id="mensaje"></div>
							<form class="form-horizontal form-label-left" id="form_cuentas_bancarias">
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-12" id="cuentas_bancarias">
								...
								<div class="form-group pull-right">
									<div class="col-md-9 col-sm-9 col-xs-12">
										<button type="submit" class="btn btn-success" id="guardar_cuenta_bancaria">Guardar</button>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<div id="listado_cuentas_bancarias"></div>
						</div>
					</div>
				</div>
			</div>
...
<!-- /Select2 -->
<script type="text/javascript" src="<?php echo $url[0].'/js/get_list_cuentas_bancarias.js'?>"></script>
</body>
</html>
