			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<div id="mensaje"></div>
							<form class="form-horizontal form-label-left" id="form_ctamovimientos">
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-12" id="tpmovimiento">
										<label>Tipo de movimiento</label>
										<select class="select2_single form-control" name='tpmovimiento'>
											<option value='20'>Recepcion de stock</option>
											<option value='21'>Salida de stock</option>
										</select>
									</div>
								...
								<div class="form-group pull-right">
									<div class="col-md-9 col-sm-9 col-xs-12">
										<button type="submit" class="btn btn-success" id="guardar_ctastock">Registrar</button>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<div id="listado_cuentastock"></div>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="<?php echo $url[0].'/js/get_list_movstock_cuenta.js'?>"></script>
</body>
</html>
