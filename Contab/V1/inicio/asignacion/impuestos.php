...
$impuesto_class = new impuestos();
$impuestos = $impuesto_class->get_impuestos();
			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<form class="form-horizontal form-label-left" id="form_iva">
								<div id="mensaje"></div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<select class="select2_single form-control" tabindex="-1" name="datos[]" multiple>
											<option></option>
											<?php foreach($impuestos as $impuesto): ?>
                                                    <?php  if ($impuesto_class->existe($impuesto->rowid) <= 0): ?>
                                                       <option value="<?php echo $impuesto->rowid ?>"><?php echo $impuesto->nombre.'-'. $impuesto->impuesto.' %' ?></option>
                                                    <?php endif ?>
											<?php endforeach  ?>
										</select>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12" id="cuentas">
								...
								<div class="form-group pull-right">
									<div class="col-md-9 col-sm-9 col-xs-12">
										<button type="submit" class="btn btn-success" id="guardar_iva">Registrar</button>
									</div>
								</div>
							</form>
						</div>
...
<!-- /Select2 -->
<script type="text/javascript" src="<?php echo $url[0].'/js/get_list_impuesto.js'?>"></script>
</body>
</html>
