				...
				<div class="col-md-12 col-xs-12">
					<div class="x_panel">
						...
						<ul class="nav right panel_toolbox" >
							...
							<li>
								<a class="btn btn-default buttons-csv buttons-html5 btn-sm add-link" title="Agregar" tabindex="0" aria-controls="datatable-buttons">
									<i class="fa fa-plus"> </i> <span style="color:#7A8196 !important;">Nuevo grupo</span>
								</a>
							</li>
						</ul>
						<div class="x_content" id="asignacion_balance">
						</div>
						<div id="add_modalGrupo" class="modal fade" role="dialog">
							<div class="modal-dialog" style="width: 62% !important;">
								<!-- Modal content-->
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$( ".add-conf" ).on( "click", function(e) {
			window.location.href = 'configuracion_apartados.php';
		});
	});
	...
	function abrirModalUpdate(idGrupo){
		$("#idgrupo").val(idGrupo);
