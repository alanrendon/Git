...
$elementtype='consultas'; //Must be the $table_element of the class that manage extrafield
...
print load_fiche_titre('Configuración de la lista de atributos adicionales (consultas)',$linkback,'title_setup');
...
dol_fiche_head($head,'consultas', 'Control Clínico', 0, 'globe');
