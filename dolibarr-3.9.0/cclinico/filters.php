...
$tabactive='';
if ($action == 'show_month') $tabactive='cardmonth2';
if ($action == 'show_week') $tabactive='cardweek2';
if ($action == 'show_day')  $tabactive='cardday2';
...
print_actions_filter2($form,$canedit,$status,$year,$month,$day,$showbirthday,0,$filtert,0,$pid,$socid,$action,$listofextcals,$actioncode,$usergroup,'', $resourceid);
dol_fiche_end();
...
if ($paciente>0) {
    $sql.= ' inner join llx_eventos_consultas as b on b.fk_evento=a.id';
}
//
...
if ($paciente>0) {
    $sql.= ' AND b.fk_paciente='.$paciente." ";
}
